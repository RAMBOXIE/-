...
const MOMLLM = (() => {
  ...
  function coreFor(){
    ...
    if (id === 'phone-3567') return { core: CORE_H, trig: triggerH };
    if (id === 'phone-5620') return { core: CORE_I, trig: triggerI };
    if (id === 'phone-9102') return { core: CORE_J, trig: triggerJ };
  ...
  function fallbackPool(){
    ...
    if (id === 'phone-3567') return TOLD_H;
    if (id === 'phone-5620') return TOLD_I;
    if (id === 'phone-9102') return TOLD_J;
