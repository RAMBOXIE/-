...
const MOMLLM = (() => {
  ...
  function coreFor(){
    ...
    if (id === 'phone-6047') return { core: CORE_K, trig: triggerK };
    if (id === 'phone-2938') return { core: CORE_L, trig: triggerL };
    if (id === 'phone-8410') return { core: CORE_M, trig: triggerM };
  ...
  function fallbackPool(){
    ...
    if (id === 'phone-6047') return TOLD_K;
    if (id === 'phone-2938') return TOLD_L;
    if (id === 'phone-8410') return TOLD_M;
