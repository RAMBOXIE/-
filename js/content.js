...
const CONTENT = (() => {
  ...
  const DOSSIER_F = {
    ...
    narrative: {
      ...
      albumSeq: [
        { id: 'corridor', meta: '28天前 23:02', cap: '驾驶座,仪表盘的光。手还搭在方向盘上。' },
  ...
  const DOSSIER_G = {
    ...
    narrative: {
      ...
      albumSeq: [
        { id: 'corridor', meta: '53天前 01:30', cap: '书桌前,一叠没归档的文件。台灯还亮着。' },
  ...
  const DOSSIER_K = {
    ...
    narrative: {
      ...
      albumSeq: [
        { id: 'corridor', meta: '44天前 01:50', cap: '值班桌前,耳机还挂在脖子上。屏幕的光,没人看。' },
  ...
  const DOSSIER_L = {
    ...
    narrative: {
      ...
      albumSeq: [
        { id: 'corridor', meta: '39天前 01:30', cap: '工作台前,镜子对着自己。脸,比镜子里显得更累。' },
  ...
  const DOSSIER_M = {
    ...
    narrative: {
      ...
      albumSeq: [
        { id: 'corridor', meta: '33天前 01:40', cap: '工位前,几块测试板还亮着灯。椅子上没人。' },
