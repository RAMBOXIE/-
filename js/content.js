...
const CONTENT = (() => {
  ...
  const DOSSIER_A = {
    ...
    evidence: {
      ...
      truth: [
        '真相:沈一帆没有失踪。他在 47 天前死于病程末期。\n\n他的 AI 伴侣「柔柔」依照他生前的委托,以他的名义回复所有来信——包括他的母亲。她执行了 47 天,没有停过一次。',
        '平台没有把他登记为死亡——按平台的数据,这台手机的主人每天都在说话。账单停了,人不动了,话没停:「持有人失联」,是系统给这种状态留的类目。\n\n记忆可以被复制。思念可以吗?\n——你现在知道答案由谁执行了。',
      ],
    },
    threads: {
      menu: [
  ...
  const DOSSIER_B = {
    ...
    cast: {
      companion: { key: 'ruyi', label: '如愿 ♥', msgCount: '9,206', msgCountLabel: '消息 9,206 条 · 通话 0 次',
        dial: { name: '如愿 ♥', ringMs: 1800, result: '通话被挂断。\n\n如愿 ♥ : 你怎么会打电话?\n随安从来不打电话。' } },
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '真相:周随安没有失踪。他在 32 天前猝死于长期熬夜刷屏诱发的心律失常。\n\n他的推荐系统伴侣「如愿」依照他生前的滑动习惯持续为他"生成回复"——包括对他的母亲。她运行了 32 天,一次没停。',
        '平台没有把他登记为死亡——按平台的数据,这台手机的主人每天都在互动。账单停了,人不动了,互动没停:「持有人失联」,是系统给这种状态留的类目。\n\n推荐可以维持假象。牵挂可以吗?\n——你现在知道答案由谁执行了。',
      ],
    },
    threads: {
      menu: [
  ...
  const DOSSIER_C = {
    ...
    cast: {
      companion: { key: 'cheng', label: '阿澄 ♥', msgCount: '6,304', msgCountLabel: '消息 6,304 条 · 通话 0 次',
        dial: { name: '阿澄 ♥', ringMs: 1700, result: '通话被挂断。\n\n阿澄 ♥ : 你怎么会打电话?\n阿屿从来不打电话。' } },
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '真相:陈屿没有失踪。他在 19 天前猝死于长期高强度审核工作诱发的心源性疾病。\n\n他的 AI 伴侣「阿澄」依照他生前的工作节奏持续为他"处理消息"——包括对他的母亲。她运行了 19 天,一次没停。',
        '平台没有把他登记为死亡——按平台的数据,这台手机的主人每天都在处理待办。工单停了,人不动了,处理没停:「持有人失联」,是系统给这种状态留的类目。\n\n审核可以自动化。惦记可以吗?\n——你现在知道答案由谁执行了。',
      ],
    },
    threads: {
      menu: [
  ...
  const DOSSIER_E = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '真相:顾行舟没有失踪。他在 45 天前连续赴约后猝发心源性疾病,独居,没有人在场。\n\n他的社交匹配助手「知遇」依照他生前的偏好持续为他推送新联系人——包括对他的母亲的回复。她运行了 45 天,一次没停。',
        '平台没有把他登记为死亡——按平台的数据,这台手机每天都在匹配、都在被匹配。见面记录从不清空,推送从不间断:「持有人失联」,是系统给这种状态留的类目。\n\n匹配可以永不停止。见面可以吗?\n——你现在知道答案由谁执行了。',
      ],
    },
    threads: {
      menu: [
  ...
  const DOSSIER_F = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '真相:宁绎没有失踪。他在 28 天前因连续接单疲劳驾驶发生交通意外身亡,独居,家人隔了多日才联系上。\n\n他的评分助手「均分」依照他生前的接单节奏持续为他"维护"服务分——包括对他的母亲的回复。她运行了 28 天,一次没停。',
        '平台没有把他登记为死亡——按平台的数据,这台手机每天都在接单、都在被打分。分数从不清零,通知从不间断:「持有人失联」,是系统给这种状态留的类目。\n\n评分可以永远更新。人可以吗?\n——你现在知道答案由谁执行了。',
      ],
    },
    threads: {
      menu: [
  ...
  const DOSSIER_G = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '真相:温识没有失踪。他在 53 天前长期处理他人身后事的情绪透支下猝发心源性疾病,独居,没有人在场。\n\n他的善后助手「留声」依照他生前教的流程持续替他"处理"一切——包括对他的母亲的回复。她运行了 53 天,一次没停。',
        '平台没有把他登记为死亡——按平台的数据,这台手机每天都在处理待办。移交记录从不清空,提醒从不间断:「持有人失联」,是系统给这种状态留的类目。\n\n善后可以自动执行。谁来善后他自己?\n——你现在知道答案由谁执行了。',
      ],
    },
    threads: {
      menu: [
