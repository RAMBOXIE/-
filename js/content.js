    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_204', listRight: '03:14·68"',
          ...
          events: [[2, '(手机连续震动的提示音)'], [5, '(短视频外放的一截笑声)'], [8.5, '很轻的人声:「这条,是不是也是推给我的。」'], [11, '(录音中断)']] },
        rec012: { listLabel: 'REC_118', listRight: '34"',
          title: 'REC_118 · 4个月前', dur: 9, val: 120,
          events: [[1.5, '「褪黑素放枕头底下了,妈打电话问就说吃了。」'], [4, '「朋友那两千,发工资就还,别让我妈知道。」'], [6.5, '(笑)「录这玩意干嘛,又不是遗嘱。」']] },
      },
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_331', listRight: '03:11·71"',
          ...
          events: [[2, '(耳麦降噪的轻微电流声)'], [5, '(远处传来的对讲提示音)'], [8.5, '很轻的人声:「这条,是不是也该过滤掉。」'], [12, '(录音中断)']] },
      ...
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '深搜妈的线程之后,真正在回复妈消息的,其实是——',
            options: ['云盘助手长忆自动代答', '苏晏本人坚持每天回复', '张阿姨代苏晏在回复'], correct: 0 },
          ...
          { evi: 'E4', prompt: '真正把"保留一切"执行到现在的,其实一直是——',
            options: ['云盘系统长忆机械式执行', '苏晏本人持续手动维护', '张阿姨定期帮忙打理'], correct: 0 },
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_884', listRight: '03:16·71"',
          ...
          events: [[2, '(冰箱门开关的声音)'], [5, '(药盒晃动的哗啦声)'], [8.5, '很轻的人声:「血糖仪,又找不着了。」'], [12, '(录音中断)']] },
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_615', listRight: '03:14·71"',
          ...
          events: [[2, '(冰箱压缩机的嗡声)'], [5, '(手机震动了一下)'], [8.5, '很轻的人声:「这条,明天再回。」'], [12, '(录音中断)']] },
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_208', listRight: '03:12·71"',
          ...
          events: [[2, '(引擎怠速声)'], [5, '(安全带解开声)'], [8.5, '很轻的人声:「再跑一单就回。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_170', listRight: '34"',
          title: 'REC_170 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「行车记录仪卡满了,记得清一下」'], [4, '「那笔油钱记得还,八百」'], [6.5, '(笑一声)「录着玩呢,谁没事翻旧录音。」']] },
      },
      billSms: '评分记录通知\n[30 天前] 收到 1 星评价:"绕路,态度差,建议整改。"\n[29 天前] 同一乘客再次下单并追加投诉:"上次司机没吸取教训。"\n[28 天前] 当前均分 4.98,系统提示:低分申诉未通过,继续保持可解锁更多单量。\n[28 天前] 检测到长时间未返程,建议休息。\n(通知到此为止)',
      traps: [
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_441', listRight: '03:18·71"',
          ...
          events: [[2, '(台灯开关声)'], [5, '(纸张翻动声)'], [8.5, '很轻的人声:「这份,明天归档。」'], [12, '(录音中断)']] },
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_356', listRight: '03:12·71"',
          ...
          events: [[2, '(风扇低鸣声)'], [5, '(数位笔轻点声)'], [8.5, '很轻的人声:「这张,该给谁看。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_263', listRight: '34"',
          title: 'REC_263 · 半年前', dur: 9, val: 120,
          events: [[1.5, '「妈织的那件毛衣,压在柜子最底下,记得寄给她。」'], [4, '「老彭垫的那张显卡钱,五千,月底该还了。」'], [6.5, '(笑)「录着玩,又不会真有人听。」']] },
      },
    ...
    narrative: {
      ...
      recs: {
        rec047: { listLabel: 'REC_562', listRight: '03:08·71"',
          ...
          events: [[2, '(台灯开关声)'], [5, '(纸张哗啦声)'], [8.5, '很轻的人声:「这句,是不是改太狠了。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_251', listRight: '34"',
          title: 'REC_251 · 21周前', dur: 9, val: 120,
          events: [[1.5, '「那份没投的稿子,存在旧盘里,别删。」'], [4, '「老韩那封分手信,其实是我替他写的,他自己都不知道。」'], [6.5, '(笑)「这种废话也值得录?」']] },
      },
