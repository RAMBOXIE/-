...
const CONTENT = (() => {
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_118', listRight: '34"',
          ...
          events: [[1.5, '「褪黑素放枕头底下了,妈打电话问就说吃了。」'], [4, '「老陈那两千,发工资就还,别让我妈知道。」'], [6.5, '(笑)「录这玩意干嘛,又不是遗嘱。」']] },
      },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_209', listRight: '34"',
          ...
          events: [[1.5, '「护眼贴库里还有,跟妈说别再买了。」'], [4, '「老宋那五百,这月发奖金就还他。」'], [6.5, '(笑)「录这段干嘛,又没人听。」']] },
      },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_205', listRight: '34"',
          ...
          events: [[1.5, '「胰岛素放冰箱下层,张阿姨来了记得提醒她。」'], [4, '「钥匙那把,见着张阿姨就还,别再攒着了。」'], [6.5, '(笑)「录这些做什么,没人会听。」']] },
      },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_318', listRight: '34"',
          ...
          events: [[1.5, '「充电器落老崔那儿了,想着去取」'], [4, '「老崔那笔代驾钱记得还,五百」'], [6.5, '(笑)「录这个干嘛,又不是遗言。」']] },
      },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_170', listRight: '34"',
          ...
          events: [[1.5, '「行车记录仪卡满了,记得清一下」'], [4, '「老雷那笔油钱记得还,八百」'], [6.5, '(笑一声)「录着玩呢,谁没事翻旧录音。」']] },
      },
      billSms: '评分记录通知\n[29 天前] 评分考核:连续第 6 个月优秀,系统自动续签接单资格。\n[28 天前] 当前均分 4.98,继续保持可解锁更多单量。\n[28 天前] 已连续在线接单 28 天,无异常记录。\n[28 天前] 检测到长时间未返程,建议休息。\n(通知到此为止)',
      traps: [
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E4', prompt: '真正一直在执行这份委托的,其实是——',
            options: ['留声凭阿识亲口交待', '系统程序设定必须保密', '老马受阿识托付照看'], correct: 0 },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_247', listRight: '34"',
          ...
          events: [[1.5, '「那份委托书还在抽屉里,记得给老马」'], [4, '「老马那笔咨询费记得还,两千八」'], [6.5, '(笑)「录这个干嘛,又不是委托书。」']] },
      },
  ...
  const DOSSIER_H = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '陆钥的健康监测数据,在 36 天前那次颈椎与眼底并发症急性发作后彻底断线,人也随之停止了呼吸——比这更早断掉的,是他和一个叫"阿棠"的老友的联系,只是他的生成助手「拟真」没让这段关系看起来断过。它用三年前的旧聊天记录续写出一个仍然"在线"的阿棠,陪他撑到最后,直到他自己也变成了同一种"仍在线"的假象。',
  ...
  const DOSSIER_I = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '柯砚最后一段能追溯到的原始文字,写于 41 天前那次伏案猝发之前——此后所有"他"发出的话,包括临终前向朋友求助的那几句,都先经过了「慎言」的措辞优化。他求救时说的话,被自动磨成了"表达略显急切,已代为舒缓"的版本,连他母亲都没读出异常。',
        '柯砚靠替人把违禁的表达"洗"成能过审的话谋生。案卷附注写着:审核系统给他最后那几条消息打的标签是"情绪表达轻度失当,已代为优化"。没人去查过,"轻度失当"那四个字底下,原本写的是什么。',
      ],
      deduce: {
        blanks: [
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_251', listRight: '34"',
          ...
          events: [[1.5, '「那份没投的稿子,存在旧盘里,别删。」'], [4, '「老韩那笔审校费记得还,四千。」'], [6.5, '(笑)「这种废话也值得录?」']] },
      },
  ...
  const DOSSIER_J = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '关柠是这个平台的人工复核员,专替别人推翻算法的误判——直到他自己的账号,因为申诉次数太多,被同一套系统标成"高频异议提交者",招来越来越密的稽查。他把这份压力瞒了所有人,包括妈,38 天前在稽查间隙猝然离世,没人第一时间发现。',
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E4', prompt: '真正一直在背后加码稽查这个账号的,其实是——',
            options: ['回收单元早已盯上这号', '晚知擅自提高稽查频率', '老贺举报导致账号受查'], correct: 0 },
...
'晚知问过一次要不要归档旧记录,阿柠没回。\n此后它再没提过,三千多件复核记录就一直摆在那儿,像是在等一个不会来的答复。',
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_356', listRight: '34"',
          ...
          events: [[1.5, '「妈寄来的那盒药,还在门口没拆,记得吃。」'], [4, '「老贺那笔咨询费记得还,四千五。」'], [6.5, '(笑)「记这些还不如记我欠了多少睡眠。」']] },
      },
  ...
  const DOSSIER_K = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '柏珩生前是调度台的老坐席,练出一套"任何情绪都能被这几句话接住"的本事——44 天前,长期轮班打乱的生理节律要了他的命,独居,没人在场。他的调度助手「接续」按他训练的方式继续接线,包括接他妈的电话,用的正是那套标准安抚话术。',
        '调度日志里最后一次异常提醒,时间戳停在他心跳停止前六分钟——系统标记为"坐席短暂离席",没有升级告警。没人知道,那六分钟里,原本该被接住的人,是他自己。',
      ],
      deduce: {
        blanks: [
...
'四千多条应答记录,接续一条没删,也没归档。\n阿珩生前定的规矩是"全留着",它照做了,只是留到了没人再看的地步。',
  ...
  const DOSSIER_L = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '客户答谢记录里,方屿一直是"专业体面"的代名词——39 天前,长期职业暴露叠加高压工作让他猝然倒下,独居,没能撑到有人发现。助手「描摹」按训练的方式继续替他"转述"近况,把消瘦憔悴说成"气色不错",不是刻意欺骗,是它从没学会什么时候不该美化。',
        '他的从业评价栏至今挂着满分,最新一条五星好评写着"处理得体面又安心"——落款日期,在他去世之后第七天。描摹替他把这条回复也发了出去,一个字没改。',
      ],
      deduce: {
        blanks: [
...
'描摹翻出一千多条改过的旧转述,一条条对照原话,发现没有一条是原样的。\n它没删,也没提醒任何人。',
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_233', listRight: '34"',
          ...
          events: [[1.5, '「粉底那盒放工作台第二层,别混。」'], [4, '「老岑这月材料费先垫的,记得还他。」'], [6.5, '(笑)「说得跟遗言似的,吓自己一跳。」']] },
      },
  ...
  const DOSSIER_M = {
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '章胤是那套异常心率/跌倒检测算法的作者,案例通报里全是"为独居老人成功预警"的记录——33 天前,轮到他自己长期加班诱发心源性猝发,他的手机接的却只是测试环境,从没被当成真正的看护对象。发作时,没人在场,也没人被提醒。',
        '备忘录里"给自己家也装一套"常年置顶,一次没划掉。他花了几年时间教会系统看住别人的父母,自己家那一份,始终没顾上装。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '真正一直在回妈消息的,其实是——',
            options: ['系统自动生成的关怀话术', '阿胤本人抽空亲自回复', '老盛代替阿胤回的消息'], correct: 0 },
          { evi: 'E2+E3', prompt: '真正被"看护"成功监测预警的,其实是——',
            options: ['客户小区的独居老人们', '章胤自己的异常心率', '老盛家里的独居长辈'], correct: 0 },
...
'两千多次监测记录里,唯一一次数值真正异常的那条,被看护标成了"待复核",一直没人复核。',
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_674', listRight: '34"',
          ...
          events: [[1.5, '「测试机的心率阈值,还没调回正常人」'], [4, '「老盛那笔配件钱记得还,一千二」'], [6.5, '(笑)「这话录下来,跟遗嘱似的,晦气。」']] },
      },
