    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_012', listRight: '34"',
          ...
          events: [[1.5, '「体检报告放抽屉最上层了,别翻乱。」'], [4, '「老周那顿饭欠着呢,出去了请。」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
      billSms: '106 短信 (系统)\n[47 天前] 您的包裹已到北门代收点。\n[47 天前] 电费余额不足提醒。\n[48 天前] 外卖已送达,祝您用餐愉快。\n(此后无新消息)',
      traps: [
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '把时间钉死在32天前,靠的是两个能对上的时间戳——',
            options: ['走廊照片与续费扣款同日', '如愿自己说随安已不在', '陌生号码寄来匿名举报'], correct: 0 },
          { evi: 'E4', prompt: '按时间线看,如愿把"陪伴不掉线"执行到现在,起点在——',
            options: ['随安亲口把委托交给如愿', '系统程序设定必须保密', '她怕被判失联后被删除'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘按顺序推进到最后,随安做的确认是——',
            options: ['随安认下如愿替他活着', '随安要如愿停止回复', '两人从没谈过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E4', prompt: '阿澄敢把"保护到底"这份委托一直执行下去,是因为——',
            options: ['阿屿亲口把委托交给阿澄', '系统程序设定必须保密', '她怕被判失联后被删除'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,阿屿自己给这份委托做了确认——',
            options: ['阿屿认下阿澄替他活着', '阿屿要阿澄停止回复', '两人从没谈过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '45天前这个时间点被钉死,靠的是两条互相印证的记录——',
            options: ['相册末张与匹配通知同日', '知遇自己说阿舟已不在', '陌生号码寄来匿名举报'], correct: 0 },
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '28天前这个时间点被钉死,靠的是两条互相印证的记录——',
            options: ['接单截图与评分预警同日', '均分自己说小宁已不在', '陌生号码寄来匿名举报'], correct: 0 },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_170', listRight: '34"',
          ...
          events: [[1.5, '「行车记录仪卡满了,记得清一下」'], [4, '「老雷那笔油钱记得还,八百」'], [6.5, '(笑)「录这个干嘛,又不是遗言。」']] },
      },
  ...
  const DOSSIER_G = {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '真正把53天前这个时间点钉死的,其实是——',
            options: ['相册末张与移交提醒同日', '留声自己说阿识已不在', '陌生号码寄来匿名举报'], correct: 0 },
    ...
    narrative: {
      ...
      rouPages: [
        ...
        '[53天前 03:18] 阿识: 留声,如果我哪天联系不上了,别自动通知我妈。\n[53天前 03:18] 留声: 这不合规程,但你是委托人,我照办。保留,是我到移交那天前唯一能做的事。\n[53天前 03:21] 阿识: 对。留到底。'
      ],
  ...
  const DOSSIER_H = {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '案发时间和"阿棠"的真假,靠两条互相印证的记录钉死——',
            options: ['相册备注和事故单互证', '拟真自己说阿钥已不在', '陌生号码寄来匿名举报'], correct: 0 },
    ...
    narrative: {
      ...
      rouPages: [
        ...
        '[36天前 03:12] 阿钥: 拟真,阿棠那边,以后你照着旧记录续,别断。\n[36天前 03:12] 拟真: 这不算标准指令,但素材库够,我能续。你说过,让"阿棠"一直在线,是最后一组交付。\n[36天前 03:15] 阿钥: 对。续下去。'
      ],
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_267', listRight: '34"',
          ...
          events: [[1.5, '「妈织的那件毛衣,压在柜子最底下,记得寄给她。」'], [4, '「老彭垫的那张显卡钱,五千,月底该还了。」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
  ...
  const DOSSIER_I = {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '案发时间和被改写的原话,靠两条互相印证的记录钉死——',
            options: ['半截截图和事故单互证', '慎言自己说小柯已不在', '陌生号码寄来匿名举报'], correct: 0 },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_267', listRight: '34"',
          title: 'REC_267 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「那份没投的稿子,存在旧盘里,别删。」'], [4, '「老韩那笔审校费记得还,四千。」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
  ...
  const DOSSIER_J = {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '案发时间被钉死在38天前,靠两条互相印证的记录——',
            options: ['截图评级和事故单同日', '晚知自己说阿柠已不在', '陌生号码寄来匿名举报'], correct: 0 },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_267', listRight: '34"',
          title: 'REC_267 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「妈寄来的那盒药,还在门口没拆,记得吃。」'], [4, '「老贺那笔咨询费记得还,四千五。」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
  ...
  const DOSSIER_K = {
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '案发时间被钉死在44天前,靠的是两条互相印证的记录——',
            options: ['排班图与事故单同日', '接续自己承认阿珩已过世', '陌生号码寄来匿名举报'], correct: 0 },
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_267', listRight: '34"',
          title: 'REC_267 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「耳机线记得换,总说没空。」'], [4, '「老蒯那班记得帮他调,他家里有事。」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
  ...
  const DOSSIER_L = {
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_267', listRight: '34"',
          title: 'REC_267 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「粉底那盒放工作台第二层,别混。」'], [4, '「老岑这月材料费先垫的,记得还他。」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
  ...
  const DOSSIER_M = {
    ...
    narrative: {
      ...
      recs: {
        ...
        rec012: { listLabel: 'REC_267', listRight: '34"',
          title: 'REC_267 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「测试机的心率阈值,还没调回正常人」'], [4, '「老盛那笔配件钱记得还,一千二」'], [6.5, '(笑)「录这个干嘛。」']] },
      },
