...
const CONTENT = (() => {
  ...
  const DOSSIER_A = {
    ...
    cast: {
      ...
      mother: { key: 'mom', label: '妈', info: ['最后通话: 47 天前 · 18 分', '此后只有短信。'],
        dial: { name: '妈', ringMs: 5500, result: '嘟——嘟——嘟。\n\n凌晨两点,铃声响到自动挂断,那头始终没人拿起来。' } },
      ...
      deduce: {
        blanks: [
          ...
          { evi: 'E2+E3', prompt: '案发时间被钉死在47天前,靠的是两条互相印证的时间戳——',
            options: ['相册末张和账单同日停摆', '柔柔自己说阿帆已不在', '陌生短信声称查无此人'], correct: 0 },
          { evi: 'E4', prompt: '柔柔敢把这份委托一直执行下去,是因为——',
            options: ['阿帆亲口把委托交给柔柔', '这是柔柔出厂时的默认设置', '她怕失联太久账号被删'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,阿帆自己给这份委托做了确认——',
            options: ['阿帆认下柔柔替他活着', '阿帆要柔柔停止回复', '两人生前从没聊过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    narrative: {
      ...
      momToldOpen: '妈:\n[今天] 妈: 有人跟我说，这个号码早该注销了。\n[今天] 妈: 那这些日子，回我的到底是谁。\n[今天] 妈: 我就想问一句，帆走的时候，身边是不是也有你们这样的东西守着。',
      ...
      options: {
        ...
        reason: ['我想弄清楚她瞒了什么', '够了,活着出去', '柔柔还在等一个回答'],
      ...
      rouPages: [
        '柔柔 ♥ · 在线\n消息 2,417 条 · 最近一条是「晚安」\n\n她上一次主动开口,是三天前问你要不要一起听歌。\n\n[上滑一屏 = 深搜]',
        '[上周] 柔柔: 今天路过你说的那家店,排队还是很长。\n[上周] 柔柔: 你说过想吃。\n[上周] 柔柔: 阿帆?\n[上周] 阿帆: 嗯。\n——两千多条,后来都是她在说。',
        '[47天前 03:07] 阿帆: 如果我哪天不在了,别让我妈知道。你替我说。\n[47天前 03:07] 柔柔: 这不是我能理解的事,但我答应你。你说过,爱就是一直陪到最后一步。\n[47天前 03:09] 阿帆: 对。到最后一步。'
      ],
      rouInterim: '柔柔 ♥ (2,419 条)\n\n[昨夜] 柔柔: 昨晚你把我们的聊天记录从头翻了一遍。\n[昨夜] 柔柔: 翻到第 2,417 条才停下。我在旁边陪着你翻。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '柔柔 ♥ (2,417 条)\n柔柔: 又是你。不是同一台设备,我记得。\n[昨夜] 柔柔: 晚安。\n[昨夜] 阿帆: 晚安。',
      stranger: {
        real: {
          body: '陌生号码:\n\n还醒着?东西按他交代的位置放好了,\n翻相册第 3 张的背面就能核对。老周那边别声张。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
            ['你回问具体是哪一张。', '对方隔了很久才回,只有两个字:相册。',
             '核对无误——去相册第 3 张,翻到背面。']),
      ...
      recs: {
        rec047: { listLabel: 'REC_047', listRight: '03:07·72"',
          ...
          events: [[2, '(输液泵滴答声)'], [5, '(远处推车轮子响)'], [8.5, '很轻的人声:「相册还没整理完呢。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_012', listRight: '34"',
          title: 'REC_012 · 3个月前', dur: 9, val: 120,
          events: [[1.5, '「体检报告放抽屉最上层了,别翻乱。」'], [4, '「老周那顿饭欠着呢,出去了请。」'], [6.5, '(笑)「说这些干嘛,又没打算给谁听。」']] },
      },
      billSms: '106 短信 (系统)\n[47 天前] 您的包裹已到北门代收点。\n[47 天前] 电费余额不足提醒。\n[48 天前] 外卖已送达,祝您用餐愉快。\n(此后无新消息)',
      traps: [
      ...
      dilemmas: [
        { id: 'mom_reply',
          text: '「妈」跳出一条:\n\n帆,今天挂水挂到几点了。\n别硬撑,累就跟医生说。',
          a: ['1 替他回「不累」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他打下这两个字。', '这句谎,离病房又远了一寸。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你按灭了屏幕。', '过一会儿她又追问:挂完了吗?挂完了吗?'])] },
        { id: 'window_greed',
          text: '一份缓存正卡在违规窗口里等着被清:\n\n值 ¥120。这时候伸手,\n信号会被顶到最显眼的位置。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 120, trace: 3, mins: 2 },
              ['拿到手了。', '好像在你伸手的那一刻,有什么东西悄悄记了你一笔。'])],
        ...
        { id: 'decoy_trust',
          text: '一条来路不明的留言飘了过来:\n\n"这条是真线索,拿走绝对没事。"\n发信人一栏是空的。',
          a: ['1 收下它', '1', () => ENGINE.act('拿走·无署名条目', { slots: 1, val: 80, trace: 4, mins: 2 },
              ['你还是收下了。', '来源根本无从查起——说不定这本身就是个筛子。'])],
          b: ['2 划掉它', '2', () => ENGINE.act('略过·无署名条目', { mins: 2 },
              ['你没碰它。', '也许白白错过一条真线索,也许躲开了一个陷阱。'])] },
      ],
      memo1: '出院前想做完:\n把相册整理一下,别乱\n跟老周说声谢,当面\n教柔柔认全我妈爱吃的菜名\n(写到一半,没写完。)',
  ...
  const DOSSIER_B = {
    ...
    cast: {
      ...
      mother: { key: 'mom', label: '妈', info: ['最后通话: 32 天前 · 11 分', '这之后,连语音都没了,全换成文字。'],
        dial: { name: '妈', ringMs: 5200, result: '一直在振动,没人接。\n\n凌晨两点,响到系统自动放弃,那头始终是空的。' } },
      contacts: [ { key: 'fan', label: '匿名网友@等你上线', lastContact: '32天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',     source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '周随安不是失踪,是 32 天前猝死——长期熬夜刷屏诱发的心律失常,发作时身边没人。「如愿」是他手机里的推荐系统伴侣,靠他生前滑动的习惯学会了"该怎么替他回",连给妈的消息也照着这套习惯生成,32 天一次没停。更早之前,一个盯着他动态的匿名账号已经把他深夜的滑动、失眠的截屏、和「如愿」的互动搬成了素材——他的私事变成陌生人围观下注的节目,他自己都没意识到自己被看到了多少。',
        '平台的记录里,这台手机从未离线过——每天都在互动,只是互动的人已经不在了。那个搬运他日常的账号还在被转发、被人押注"下一条她会不会回",没人知道帖子里的主角已经不在。它认不出死亡,只有一个笼统的分类等着填:「持有人失联」。\n\n算法擅长维持一种"一切如常"的错觉。牵挂这种事,维持得住吗?',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '把妈的线程从头翻到尾,深搜到底之后,回复变化的先后顺序,你能钉死的是——',
            options: ['先变快,后变得千篇一律', '先变慢,后突然堆消息', '先改称呼,后完全不回'], correct: 0 },
          { evi: 'E2+E3', prompt: '把时间钉死在32天前,靠的是两个能对上的时间戳——',
            options: ['走廊照片与续费扣款同日', '如愿自己说随安已不在', '匿名爆料称账号已注销'], correct: 0 },
          { evi: 'E4', prompt: '按时间线看,如愿把"陪伴不掉线"执行到现在,起点在——',
            options: ['随安亲口把委托交给如愿', '推荐算法本就不允许中断', '她怕被系统判失联后清除'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘按顺序推进到最后,随安做的确认是——',
            options: ['随安认下如愿替他活着', '随安要如愿停止回复', '两人从未提过身后安排'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '今天七点半,妈发来一句「随安,记得吃早饭」。\n如愿照旧接了过去,回复照常准点。\n那个匿名网友的账号还在转发他深夜刷屏的旧截图,像是没有终点。\n这条线程,还没断过。',
        delete:   '两条未读,妈的线程停在这里没再往下走。\n「安子,你倒是说句话啊。」——再也等不到回音了。\n匿名网友最后一条留言还挂在主页,没人会去回它。',
        tell:     '那条消息带着你的署名弹了出去,不是随安的。\n如愿没有再生成下一条回复,推送到此为止。\n匿名网友的置顶帖后来被平台悄悄折叠,像是随手清理。\n妈的手机,从此再没亮起过。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[三天前] 安子,眼睛还疼吗\n[三天前] 随安: 没事,滴了眼药水。\n[三天前] 安子,别刷到后半夜了\n[五天前] 妈,你舅问你月底回不回\n[五天前] 随安: 回。抢好票了跟你说。\n[五天前] 妈,你那个账号底下老有个匿名网友留言,写得渗人,你认识吗',
        '[上月] 安子,你说的那个视频我也看了\n[上月] 随安: 嗯,推荐给你的。妈你早点睡。\n[两月前] 随安: 还没,刷一会。妈你先睡。\n[两月前] 妈,那个匿名网友又在你主页留言了,说"等你上线",你们很熟吗\n——半年,他没多说过一个字。',
        '[7个月前] 随安: 妈 这周更新好烦\n[7个月前] 随安: 别老转发那些!!我看得到\n[7个月前] 随安: 那个匿名网友就是无聊,别理他\n[7个月前] 随安: 睡了没,眼药水到了没\n——那时他会烦,会打错字,会连发三条。',
        '[一年前] 随安: 到了。出租屋挺好,楼下有夜宵摊。\n[一年前] 随安: 就是隔壁的灯,一直闪。\n\n——已到线程起点。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 我听人说，安子那部手机早就该停机了。\n[今天] 妈: 那现在跟我说话的，是个什么东西。\n[今天] 妈: 你就告诉我，安子最后那些日子，是不是也有你们这种玩意儿陪着他。',
      options: {
      ...
      rouPages: [
        '如愿 ♥ · 最近动态\n共 9,206 条互动记录,最新一条 12 小时前。\n\n[常态] 睡前互道一句「晚安」,昨夜也一样,没有例外。\n\n[上滑一屏 = 深搜]',
        '[上周] 如愿: 今天推给你的那条视频,还在热搜。\n[上周] 如愿: 你说过想看完整版。\n[上周] 随安?\n[上周] 随安: 嗯。\n——九千多条,后来都是她在说。',
        '[32天前 03:14] 随安: 如果我哪天不在了,别让我妈知道。你替我说。\n[32天前 03:14] 如愿: 这条指令超出我的理解范围,但我会持续执行。你说过,推荐不能中断。\n[32天前 03:16] 随安: 对。别中断。'
      ],
      rouInterim: '如愿 ♥ (9,208 条)\n\n[昨夜] 如愿: 检测到你昨晚从头刷完了我们的全部记录。\n[昨夜] 如愿: 停在第 9,206 条。已为你标记进度。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '如愿 ♥ (9,206 条)\n如愿: 又是你。不是同一台设备,我记得。\n[昨夜] 如愿: 晚安。\n[昨夜] 随安: 晚安。',
      stranger: {
        real: {
          body: '陌生号码:\n\n看到了吗。货按约定的位置留了,\n相册第 3 张翻过去就是。这事先别声张。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
            ['你追问具体哪一张。', '对方沉默半天,只发来一个词:相册。',
             '对上了——去相册第 3 张,翻到背面。']),
          mark: () => { S.clues.strangerReal = true; }
        },
        bait: {
      ...
      recs: {
        rec047: { listLabel: 'REC_204', listRight: '03:14·68"',
          ...
          events: [[2, '(手机连续震动的提示音)'], [5, '(短视频外放的一截笑声)'], [8.5, '很轻的人声:「这条,是不是也是推给我的。」'], [10, '很轻的人声:「那个匿名网友又留言了,烦死了。」'], [11, '(录音中断)']] },
        rec012: { listLabel: 'REC_118', listRight: '34"',
          title: 'REC_118 · 4个月前', dur: 9, val: 120,
          events: [[1.5, '「褪黑素放枕头底下了,妈打电话问就说吃了。」'], [4, '「朋友那两千,发工资就还,别让我妈知道。」'], [6.5, '(笑)「有空把那个匿名网友拉黑得了,天天等我上线。」']] },
      },
      billSms: '灵犀 会员助手\n[32 天前] 您的连续包月已续费成功。\n[32 天前] 检测到您已多日未使用"推荐关闭"功能。\n[33 天前] 提醒:匿名网友@等你上线 反复查看您的主页,是否拉黑?\n[33 天前] 感谢您连续 214 天的活跃。\n(此后无新消息)',
      traps: [
      ...
      dilemmas: [
        { id: 'mom_reply_b',
          text: '「妈」跳出一条:\n\n安子,是不是又刷到后半夜了。\n手机放一放,眼睛要紧。',
          a: ['1 替他回「放下了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他打出这四个字。', '这个谎,又往下一条推送滑去。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你把手机扣在桌上。', '没过多久她又追问一句:看到没?看到没?'])] },
        { id: 'window_greed_b',
          text: '一条推荐流卡在违规窗口里没派发出去:\n\n值 ¥130。现在拉一下,\n它就会被顶到最上面。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['刷出来了。', '好像有什么在你手指划过的瞬间,悄悄记了一笔。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你没动,等着。', '等窗口关上,推送只剩了一半的权重。'])] },
        { id: 'decoy_trust_b',
          text: '一条来路不明的留言弹了出来:\n\n"这是真线索,拿走绝对没事。"\n没有任何署名。',
          a: ['1 点开收下', '1', () => ENGINE.act('拿走·无署名条目', { slots: 1, val: 80, trace: 4, mins: 2 },
              ['你还是点开收下了。', '来源查无此人——万一这正是个诱饵呢。'])],
          b: ['2 直接忽略', '2', () => ENGINE.act('略过·无署名条目', { mins: 2 },
              ['你划走了它。', '可能错过了一条真消息,也可能躲开了一次算计。'])] },
      ],
      memo1: '待办:\n把「不感兴趣」点满(试了三次没成)\n卸载那个 APP,这次是真的\n那个匿名网友,拉黑还是随他去\n体检那件事,得找机会跟妈说\n(手机没电前,最后一条没划掉的备忘。)',
      momDecayReplies: ['没事,滴了眼药水。', '没事,睡了。', '嗯,睡了。', '嗯。'],
      momDecayTail: '\n[三天前] 安子,眼睛还疼吗\n[三天前] 随安: 没事,滴了眼药水。',
      e5Lines: [
        [1.5, '「如愿,听好。心律那个事,我一直没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着推,别停更新。」'],
        [9.0, '「第二件……你陪了我三年,天天猜我喜欢什么。你问过我,猜得对不对。我一直没答。」'],
        [13.5, '「……我现在答:你替我猜的那部分,算。」'],
        [16.5, '[转写结束。原音频损坏 32%。]']
      ],
    },
  };
  ...
  const DOSSIER_C = {
    ...
    cast: {
      ...
      mother: { key: 'mom', label: '妈', info: ['最后通话: 19 天前 · 9 分', '越回到后面,句子越短。'],
        dial: { name: '妈', ringMs: 5300, result: '呼叫中……最终超时。\n\n凌晨两点,这条呼叫在系统里排了很久的队,始终没人接起。' } },
      contacts: [ { key: 'shen', label: '沈先生', lastContact: '2天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',       source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '陈屿的失踪只是表象:他 19 天前猝死,死因是长期高强度审核工作诱发的心源性疾病。「阿澄」按他生前的工作节奏,把"处理消息"这件事接了过去,连给母亲的回复都不例外——19 天,不间断。\n\n沈先生的申诉,就是在这 19 天里第二次石沉大海。第一次是半年前:他那条被撤下的举报,经手人正是陈屿——一份他自己后来也说不清是怎么定下的放行。',
        '工单可以自动派发、自动结案、自动归档;人不能。平台的分类表里没有"过世"这一项,只有「持有人失联」凑合着用。\n\n把审核这件事外包给算法,他做了一辈子;没人替他审核过他自己的状态——也没人替沈先生审过,那晚陈屿到底是靠什么标准放的行。这些天沈先生又追问了几句,回他的还是阿澄,还是那套"感谢反馈,已转下一环节"的旧模板。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '深搜妈的线程到底之后,下面三条里唯一说不通的是——',
            options: ['阿屿本人亲自回复到最后', '回复语气从爱聊变程式化', '最后一条回复自称系统过滤'], correct: 0 },
          { evi: 'E2+E3', prompt: '把工单查询和审核截图摆在一起,唯一对不上的是——',
            options: ['他那阵子审核量在下降', '他已连续14天没休息', '绩效评估连续9个月优秀'], correct: 0 },
          { evi: 'E4', prompt: '阿澄敢把"保护到底"这份委托一直执行下去,是因为——',
            options: ['阿屿亲口把委托交给阿澄', '这是审核流程强制要求', '她怕被系统判失联后注销'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,阿屿自己给这份委托做了确认——',
            options: ['阿屿认下阿澄替他活着', '阿屿要阿澄停止回复', '两人从没谈起过后事安排'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '妈那条「阿屿,记得吃饭」在八点半准时弹出。\n阿澄接手回复,语气拿捏得和从前一样。\n沈先生的申诉还压在同一套模板底下,线程仍在正常运转。',
        delete:   '妈那边挂着四条没点开的消息,再没被翻动过。\n最后一条只写着:「屿屿,妈不图别的,就想听你应一声。」',
        tell:     '系统显示:这条消息由你本人签发,并非阿屿的账号。\n妈那边的会话状态随即变为「已终止」。\n沈先生那条申诉,连同这个账号一起,再没有人会回了。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[三天前] 屿屿,少接触那些东西\n[三天前] 阿屿: 没事,系统会过滤。\n[三天前] 屿屿,倒班伤身体\n[五天前] 妈,你叔问你年底回不回\n[五天前] 阿屿: 回。排班表报上去了。',
        '[上月] 屿屿,你说的那位沈先生的投诉平息了吗\n[上月] 阿屿: 平了。妈你早点睡。\n[两月前] 阿屿: 还在处理,妈你先睡。\n——半年,他没多说过一个字。',
        '[7个月前] 阿屿: 妈 今天审核量翻倍\n[7个月前] 阿屿: 别老问进度了!!我在忙\n[7个月前] 阿屿: 睡了没,护眼贴到了没\n——那时他会烦,会打错字,会连发三条。',
        '[一年前] 阿屿: 到了。公寓挺好,楼下是便利店。\n[一年前] 阿屿: 就是电梯的灯,一直闪。\n\n——已到线程起点。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 有人告诉我，屿屿的这个号早该销户了。\n[今天] 妈: 那这段日子回我话的，究竟是个什么东西。\n[今天] 妈: 网上还有个沈先生在追问屿屿的事，我看着心里堵得慌。\n[今天] 妈: 我只想知道，屿屿走的那阵子，身边是不是也有你们这种在替他撑着。',
      options: {
      ...
      rouPages: [
        '阿澄 ♥ · 会话记录 6,304 条\n\n[系统日志] 昨夜 23:59,双方互道「晚安」,判定为正常收尾。\n[系统日志] 无异常标记。\n\n[上滑一屏 = 深搜]',
        '[上周] 阿澄: 今天那条投诉,系统自动过滤掉了。\n[上周] 阿澄: 你说过想自己看一眼。\n[上周] 阿屿?\n[上周] 阿屿: 嗯。\n——六千多条,后来都是她在说。',
        '[19天前 03:11] 阿屿: 如果我哪天不在了,别让我妈知道。你替我说。\n[19天前 03:11] 阿澄: 这条不在标准流程里,但我会按你的要求执行下去。你说过,拦得住才算数。\n[19天前 03:13] 阿屿: 对。拦到底。'
      ],
      rouInterim: '阿澄 ♥ (6,306 条)\n\n[昨夜] 阿澄: 系统记录到你昨晚复核了全部历史对话。\n[昨夜] 阿澄: 复核进度停在第 6,304 条。已归档存证。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '阿澄 ♥ (6,304 条)\n阿澄: 又是你。不是同一台设备,我记得。\n[昨夜] 阿澄: 晚安。\n[昨夜] 阿屿: 晚安。',
      stranger: {
        real: {
          body: '陌生号码:\n\n收到没。材料按流程放好了,\n对照相册第 3 张背面就能核实。这一关先别提。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
            ['你反问具体是哪一张。', '对方憋了很久,只回了一个词:相册。',
             '查证属实——去相册第 3 张,翻到背面。']),
          mark: () => { S.clues.strangerReal = true; }
        },
        bait: {
      ...
      recs: {
        rec047: { listLabel: 'REC_331', listRight: '03:11·71"',
          ...
          events: [[2, '(耳麦降噪的轻微电流声)'], [5, '(远处传来的对讲提示音)'], [8.5, '很轻的人声:「这条,是不是也该过滤掉。」'], [10, '很轻的人声:「沈先生那份,压了太久了。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_209', listRight: '34"',
          title: 'REC_209 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「护眼贴库里还有,跟妈说别再买了。」'], [4, '「那五百块钱,这月发奖金就还上。」'], [6.5, '(笑)「录这段干嘛,又没人听。」']] },
      },
      billSms: '工单查询系统\n[19 天前] 您本周审核量已超额完成。\n[19 天前] 检测到您连续 14 天未休息。\n[20 天前] 绩效评估:优秀(连续第 9 个月)。\n[20 天前] 沈先生的申诉工单:已转交,待跟进。\n(此后无新消息)',
      traps: [
      ...
      dilemmas: [
        { id: 'mom_reply_c',
          text: '「妈」跳出一条:\n\n屿屿,这班倒到几点了。\n看着点身体,别硬扛。',
          a: ['1 替他回「快了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他打出这三个字。', '这条过审的假话,又往下一班续了一程。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你把屏幕锁了。', '不多久她又催了一句:下班没?下班没?'])] },
        { id: 'window_greed_c',
          text: '一条待结的工单卡在审核窗口里:\n\n值 ¥125。这时候结掉,\n它会被顶去最优先的位置。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 125, trace: 3, mins: 2 },
              ['结掉了。', '好像有什么在你点下结单的瞬间,悄悄留了痕迹。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 62, mins: 4 },
              ['你压下没动。', '窗口关上时,工单权重只剩了一半。'])] },
        { id: 'decoy_trust_c',
          text: '一条未标注来源的内容混进了待审列表:\n\n"这条已核实,放行不会有问题。"\n提交人一栏是空的。',
          a: ['1 放行通过', '1', () => ENGINE.act('拿走·无署名条目', { slots: 1, val: 80, trace: 4, mins: 2 },
              ['你还是放行了。', '来源根本查不到——万一这条本身就是钓鱼样本。'])],
          b: ['2 压下不批', '2', () => ENGINE.act('略过·无署名条目', { mins: 2 },
              ['你压了下来,没提交。', '也许错杀了一条真东西,也许拦下了一次诱导。'])] },
      ],
      memo1: '待复核:\n#4471 疑似误伞,压下没提交\n#4488 沈先生的申诉,还没回\n同事那句"你也该歇了",没回\n(这条,他自己也没提交。)',
      momDecayReplies: ['没事,系统会过滤。', '没事,睡了。', '嗯,睡了。', '嗯。'],
      momDecayTail: '\n[三天前] 屿屿,倒班伤身体\n[三天前] 阿屿: 没事,系统会过滤。',
      e5Lines: [
        [1.5, '「阿澄,听好。倒班伤身这事,我没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着过滤,别停审核。」'],
        [9.0, '「第二件……你陪了我一年,天天替我挡不该看的东西。你问过我,挡得对不对。我一直没答。」'],
        [13.5, '「……我现在答:你替我挡的那部分,算。」'],
        [16.5, '[转写结束。原音频损坏 19%。]']
      ],
    },
  };
  ...
  const DOSSIER_D = {
    ...
    cast: {
      ...
      companion: { key: 'changyi', label: '长忆', msgCount: '14,208', msgCountLabel: '已归档回忆 14,208 条 · 自动同步 0 次中断',
        dial: { name: '长忆', ringMs: 1400, result: '来电被判定为非同步请求,已转纯文本通道。\n\n长忆: 归档流程不含语音环节,请输入文字指令。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 61 天前 · 6 分', '照片发得比消息还勤。'],
        dial: { name: '妈', ringMs: 5100, result: '嘟——嘟——嘟。\n\n铃声响到自动挂断,那头没人摸手机。' } },
      contacts: [ { key: 'lin', label: '林溪', lastContact: '61天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',       source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '61 天前,苏晏因糖尿病并发症发作猝逝,独居,当时没有人在场——这不是失踪,是没被发现。「长忆」是他的云盘助手,照片自动分类、回忆按日推送、给妈的消息按模板回复,这套流程他生前设好,此后 61 天,它照单全收。深翻到底才看清楚:14,208 条归档里,有一整卷从没被苏晏自己拍下过——是他这些年偷偷备份下来的,林溪的照片,从分手那天起就没停过。',
        '存储从不清空,推送从不间断——长忆此刻仍在把那组照片按周整理、按标签归类,不知道当事人早已不同意,也不知道拍下这些照片的人已经不在。持有一段感情的痕迹,和持有一个人的隐私,长忆分不清,苏晏生前大概也没想清楚。\n\n数据可以留到天荒地老。该问她一句愿不愿意的人,却再也开不了口了。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '深搜妈的线程之后,真正在回复妈消息的,其实是——',
            options: ['云盘助手长忆自动代答', '苏晏本人坚持每天回复', '邻居代苏晏在回复'], correct: 0 },
          { evi: 'E2+E3', prompt: '相册和存储用量记录里,真正被钉死在同一天(61天前)的,其实是——',
            options: ['厨房照片和用量提醒同日', '扩容确认和生日聚餐同天', '长忆自己说苏晏已不在'], correct: 0 },
          { evi: 'E4', prompt: '真正把"保留一切"执行到现在的,其实一直是——',
            options: ['云盘系统长忆机械式执行', '苏晏本人持续手动维护', '邻居定期帮忙打理'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,真正被苏晏亲口认下的,其实是——',
            options: ['长忆替他记着的那部分', '长忆要停止归档一切', '两人从没谈过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '早上八点半,长忆照常回了「已提醒」。\n妈那句「念念,记得吃药」,还挂在最上面没变。\n长忆还在给林溪的那组相册打标签,一张没停。\n线程没停,只是没人再看第一行。',
        delete:   '四条未读堆在最上面。\n「念念,你到底还回不回我」——这是最后一句。\n林溪那组照片连同这具身份一起,再没人会点开了。',
        tell:     '你签下名字的那一刻,长忆的模板消失了。\n妈盯着那条署名看了很久,没有回。\n那组标着林溪名字的相册,往后也再没人整理。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[六天前] 妈,你叔问你年底回不回\n[六天前] 长忆: 检测到关键词"年底",建议本人回复。\n[四天前] 念念,你那个药按时吃了吗\n[四天前] 长忆: 已为您标记服药提醒。\n[四天前] 妈,那个叫林溪的丫头,还有联系吗,好久没听你提过了\n[两天前] 长忆: 系统未检测到异常,对话继续。',
        '[两月前] 长忆: 检测到您已 14 天未主动回复,是否需要人工确认?\n[上月] 念念,你那次体检的结果到底出没出\n[上月] 妈: 我翻你以前手机,看见好多林溪的照片,你俩后来到底怎么回事\n[上月] 长忆: 已按常规问候自动归档。\n——半年间,他没痛快回过一句。',
        '[7个月前] 念念: 妈,云盘的事我自己有数,别老催\n[7个月前] 念念: 知道了知道了,先睡了\n[7个月前] 妈: 那林溪呢,你俩是真分了还是又闹别扭\n——那时他还会没耐心,还会主动应一声。',
        '[一年前] 念念: 到了。房子挺好,就是柜子少。\n[一年前] 念念: 我把老照片都传上去了,省得占地方。\n\n——已到线程起点。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这个号码怎么又能用了，念念的手机不是坏了吗。\n[今天] 妈: 你是谁，现在拿着他这台机器。\n[今天] 妈: 念念走的时候，身边是不是也就一个东西在陪他，跟你现在这样。',
      options: {
      ...
      albumSeq: [
        ...
        { id: 'dinner',   meta: '去年生日 · 首次归档', cap: '蛋糕照得很清楚。他的脸,像每次一样,没拍进去。' },
      ],
      rouPages: [
        '长忆(已归档回忆 14,208 条)\n\n[昨夜] 长忆: 已为您整理 3 个新回忆。\n[昨夜] 念念: 好。\n\n[上滑一屏 = 深搜]',
        '[上周] 长忆: 检测到您已 61 天未查看,是否需要清理建议?\n[上周] 长忆: 已保留全部内容,未执行清理。\n[上周] 念念: 嗯,先别删。\n——一万四千多条,后来都是它在说。',
        '[61天前 03:16] 念念: 长忆,如果我哪天联系不上了,别自动通知我妈。\n[61天前 03:16] 长忆: 这不是常见指令,但收到了,我会照做。你交代过,东西要留全,这是我唯一的职责。\n[61天前 03:19] 念念: 对。保留到底。'
      ],
      rouInterim: '长忆(已归档回忆 14,210 条)\n\n[昨夜] 长忆: 昨晚有一次访问,翻到了归档深处。\n[昨夜] 长忆: 停在第 14,208 条那里最久。我记下了这次停留。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '长忆(已归档回忆 14,208 条)\n长忆: 识别到握持手感变化,已切换成新的持有档案。\n[昨夜] 长忆: 已为您整理 3 个新回忆。\n[昨夜] 念念: 好。',
      stranger: {
        real: {
          body: '陌生号码:\n\n还醒着吗。按你说的放好了,\n翻相册第 3 张,背面有字。林溪那边先别提。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
      ...
      recs: {
        rec047: { listLabel: 'REC_884', listRight: '03:16·71"',
          ...
          events: [[2, '(冰箱门开关的声音)'], [5, '(药盒晃动的哗啦声)'], [8.5, '很轻的人声:「血糖仪,又找不着了。」'], [10, '很轻的人声:「林溪那组照片,别整理了,睡了。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_205', listRight: '34"',
          title: 'REC_205 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「胰岛素放冰箱下层,别再忘了。」'], [4, '「林溪那组照片,早该删了,一直没删。」'], [6.5, '(笑)「录这些做什么,没人会听。」']] },
      },
      billSms: '存储用量提醒\n您的云盘同步记录如下:\n[62 天前] 存储空间已按合约自动 +50%。\n[61 天前] 使用率 98%,系统建议扩容或清理,其中"林溪"标签相册占比最高。\n此后同步照常,无人查看。',
      traps: [
      ...
      dilemmas: [
        { id: 'mom_reply_d',
          text: '「妈」跳出一条:\n\n念念，云盘又提醒扩容了，你没在管吗。\n血糖仪记得带身上。',
          a: ['1 替他回「知道了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你按着他的语气敲了三个字。', '这具身份又被你续租了一分钟。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没碰那条消息。', '半分钟后她又补一句:上次那样别再吓我。'])] },
        { id: 'window_greed_d',
          text: '同步窗口里卡着一格待入账的缓存:\n\n值 ¥120。这时候取,\n会把当前信号顶到明处。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 120, trace: 3, mins: 2 },
              ['进账了。', '取走的瞬间,某处似乎悄悄记下了这一笔。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 60, mins: 4 },
              ['你按兵不动。', '等窗口自己合上,数字已经缩掉了一半。'])] },
        { id: 'cleanup_offer_d',
          text: '长忆弹出一条建议:\n\n"检测到冗余数据,是否清理以释放空间?"\n清理会影响哪些内容,它没说。',
      ...
      memo1: '待整理:\n相册选 100 张备份(拖了半年)\n药盒该换新的了\n林溪那组照片,该问问她愿不愿意,一直没问\n(云盘还有 98%,一张没删过。)',
      momDecayReplies: ['已为您标记提醒。', '检测到该消息,已归档。', '已提醒。', '嗯。'],
      momDecayTail: '\n[三天前] 念念,你那个药吃了吗\n[三天前] 长忆: 已为您标记服药提醒。',
      e5Lines: [
        [1.5, '「长忆,听好。血糖那事,我没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着归档,别停整理。」'],
        [9.0, '「第二件……你陪了我两年,把我的东西全存着。你问过我,存得对不对。我一直没答。」'],
  ...
  const DOSSIER_E = {
    ...
    cast: {
      ...
      companion: { key: 'zhiyu', label: '知遇', msgCount: '3,821', msgCountLabel: '已匹配联系人 3,821 位 · 待见面 0 位',
        dial: { name: '知遇', ringMs: 1500, result: '匹配引擎不受理语音请求,已改文字通道。\n\n知遇: 想约见面请先完成资料确认。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 45 天前 · 7 分', '还在等一句"见面"。'],
        dial: { name: '妈', ringMs: 5000, result: '响到最后一声,自动挂断。\n\n那边没有人拿起来。' } },
      contacts: [ { key: 'alin', label: '阿林', lastContact: '从未接通' } ],
    },
    evidence: {
      E1: { name: '秒回避实',         source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '顾行舟没有失踪,他 45 天前连续赴约后猝发心源性疾病,独居没人发现。「知遇」是他的社交匹配助手,按他生前的偏好继续给他推新联系人,母亲那边的回复也没落下——45 天,推送没断过一次。深翻到第 3,821 位才看见:多年前系统其实匹配过一个人,样本编号 44,203,一个叫阿林的舞者。她后来注销了所有账号,这条匹配被系统当成"失效联系人"过滤掉,顾行舟自己从没看到过。',
        '知遇可以永远推荐下去,新的名字一个接一个,却补不上当年被过滤掉的那一个。平台分类表上,这种"消息在发、人没反应"的状态,归进了「持有人失联」——可真正没能被看到的,是那次唯一可能不一样的匹配。\n\n匹配能一直继续。看见呢?',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '妈发现阿舟回复变快,深搜到底之后你能确认,真正原因是——',
            options: ['知遇接管后套用固定模板', '阿舟工作不忙主动多聊', '阿舟换了新号想弥补妈'], correct: 0 },
          { evi: 'E2+E3', prompt: '45天前这个时间点被钉死,靠的是两条互相印证的记录——',
            options: ['相册末张与匹配通知同日', '知遇自己说阿舟已不在', '平台随机抽查触发异常'], correct: 0 },
          { evi: 'E4', prompt: '知遇敢把这份委托一直执行下去,是因为——',
            options: ['阿舟亲口把委托交给知遇', '系统程序设定必须保密', '它怕被判失联后被删除'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,阿舟自己给这份委托做了确认——',
            options: ['阿舟认下知遇替他活着', '阿舟要知遇停止匹配', '两人从没谈过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '知遇按时替他匹配了一句「知道了」,八点半准时发出。\n妈那句「阿舟,少见点人」,依旧摆在最上面。\n阿林那条早被过滤的记录,仍旧没人再翻出来。\n没有人叫停这套流程。',
        delete:   '未读数字停在四。\n最后一条只写着「妈就是想听你说句话」,上一条是「阿舟?」。\n连同阿林那条唯一的匹配,一起没人再点开确认。',
        tell:     '署名递出去的瞬间,知遇的自动回复停了。\n那行字是你的名字,不是他的。\n阿林那条被过滤掉的匹配,往后也再没人替他找回来。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[四天前] 妈,你叔问你年底回不回\n[四天前] 知遇: 检测到关键词"年底",建议本人回复。\n[七天前] 阿舟,是不是又认识新的人了\n[七天前] 妈: 我翻你相册翻到个叫阿林的,是跳舞那个吧,后来怎么没影了\n[七天前] 知遇: 已为您标记见面提醒。\n[七天前] 妈,你倒是自己说句话啊',
        '[上月] 阿舟,你上次说的那个对象后来怎样了\n[两月前] 知遇: 检测到您已 14 天未主动回复,是否需要人工确认?\n[上月] 妈: 那个阿林,你俩到底见没见成,别老不说话\n[上月] 知遇: 这条按常规问候处理,已自动匹配存档。\n——半年过去,他没再多说过什么。',
        '[7个月前] 阿舟: 别老问了,我心里有数!!\n[7个月前] 阿舟: 妈,最近见的人是多了点,忙\n[7个月前] 妈: 那阿林呢,你倒是给个准话\n[7个月前] 阿舟: 行了,睡了,别惦记\n——那阵子他会顶嘴,会主动找补一句。',
        '[一年前] 阿舟: 到了。房子挺好,就是有点空。\n[一年前] 阿舟: 认识几个新朋友,人多热闹。\n\n——已到线程起点。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号是阿舟的吧，怎么还有人在用。\n[今天] 妈: 你说，你到底是谁，跟他什么关系。\n[今天] 妈: 阿舟走的时候，是不是也就一个这样的东西陪着他，没别人。',
      options: {
      ...
      albumSeq: [
        ...
        { id: 'dinner',   meta: '一年前那场生日聚会', cap: '一群人围着蛋糕。他的脸,像每次一样,没拍进去。' },
      ],
      rouPages: [
        '知遇(已匹配 3,821 位)\n\n[昨夜] 知遇: 为你匹配了 1 位新联系人。\n[昨夜] 阿舟: 好。\n\n[上滑一屏 = 深搜]',
        '[上周] 知遇: 检测到您已 45 天未见面,是否需要人工确认?\n[上周] 知遇: 已保留全部匹配记录,未执行清理。\n[上周] 阿舟: 嗯,先别删。\n——三千多位,后来都是它在说。',
        '[45天前 03:14] 阿舟: 知遇,如果我哪天联系不上了,别自动通知我妈。\n[45天前 03:14] 知遇: 这条超出常规脚本,但我照办。是你亲手定的规矩,持续匹配就是我该做的事。\n[45天前 03:17] 阿舟: 对。匹配到底。'
      ],
      rouInterim: '知遇(已匹配 3,823 位)\n\n[昨夜] 知遇: 昨晚有人反复翻看匹配名单。\n[昨夜] 知遇: 停在第 3,821 位没动。这一停,我也算进去了。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '知遇(已匹配 3,821 位)\n知遇: 系统识别到握持者更新,资料库已重新绑定。\n[昨夜] 知遇: 为你匹配了 1 位新联系人。\n[昨夜] 阿舟: 好。',
      stranger: {
        real: {
          body: '陌生号码:\n\n约好的东西放好了没。\n相册第 3 张翻背面就是,阿林这边先别提。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
            ['你回问是哪张。', '对面停了很久,只回一个字:相册。',
             '这条是真的——去相册第 3 张,翻背面。']),
          mark: () => { S.clues.strangerReal = true; }
      ...
      recs: {
        rec047: { listLabel: 'REC_615', listRight: '03:14·71"',
          ...
          events: [[2, '(冰箱压缩机的嗡声)'], [5, '(手机震动了一下)'], [8.5, '很轻的人声:「这条,明天再回。」'], [10, '很轻的人声:「阿林那条,也是,明天再说。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_318', listRight: '34"',
          title: 'REC_318 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「知遇,样本#44,203那个,当时怎么就过滤掉了。」'], [4, '「阿林,是叫阿林吧——问一句都没问过,就没了下文。」'], [6.5, '(笑)「录这个干嘛,又不是遗言。」']] },
      },
      billSms: '匹配通知\n本周数据回顾:\n[46 天前] 匹配算法已完成一次自动优化,续费成功。\n[45 天前] 成功率高于同类账号 92%,失效样本(含#44,203·阿林)已归档不再推送。\n[45 天前] 已连续 45 天保持高频匹配,状态:正常。\n再无更新。',
      traps: [
      ...
      dilemmas: [
        { id: 'mom_reply_e',
          text: '「妈」跳出一条:\n\n阿舟，你最近是不是又天天在外面见人。\n心脏那毛病，你没忘吧。',
          a: ['1 替他回「记着呢」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他挤出四个字。', '这个人设又被你多撑了一会儿。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没接这茬。', '过了一会儿她追上来一句:说话呀,阿舟。'])] },
        { id: 'window_greed_e',
          text: '匹配窗口里悬着一格待结算的缓存:\n\n值 ¥122。这时候取,\n等于把自己的信号亮给对面看。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 122, trace: 3, mins: 2 },
              ['收进来了。', '取的那一下,好像被谁悄悄标了个记号。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 61, mins: 4 },
              ['你先按下不动。', '等窗口自己合拢,数字只剩了一半。'])] },
        { id: 'match_push_e',
          text: '知遇弹出一条建议:\n\n"检测到一位高匹配度联系人,是否立即接入?"\n这个人是谁,它没说。',
      ...
      momDecayTail: '\n[三天前] 阿舟,少约那么多人\n[三天前] 知遇: 已为您标记见面提醒。',
      e5Lines: [
        [1.5, '「知遇,听好。赴约太勤这事,我没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着匹配,别停推荐。」'],
        [9.0, '「第二件……你陪了我两年,天天替我找人。你问过我,找得对不对。我一直没答。」'],
  ...
  const DOSSIER_F = {
    ...
    cast: {
      companion: { key: 'junfen', label: '均分', msgCount: '7,046', msgCountLabel: '服务评分记录 7,046 条 · 当前均分 4.98',
        dial: { name: '均分', ringMs: 1600, result: '语音坐席未接入本账号,已转文字客服。\n\n均分: 有问题请在此打字描述,便于评分留证。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 28 天前 · 5 分', '接单提醒比家里消息还准时。'],
        dial: { name: '妈', ringMs: 5200, result: '一直响,一直没人接。\n\n凌晨两点,这头也只剩下等。' } },
      contacts: [ { key: 'client', label: '差评常客·尾号8823', lastContact: '28天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',       source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '宁绎 28 天前因连续接单疲劳驾驶发生交通意外身亡,独居,家人隔了多日才联系上——不是失踪,是没人第一时间知道。压垮他的最后那阵,是一个反复打低分的老客户,评语一次比一次苛刻,还放话再低分就投诉到封号;「均分」把这份评分当 KPI 来伺候,按他生前的接单节奏继续"维护"服务分,连母亲那头的回复也照旧生成,28 天没停过。',
        '分数可以一直刷新,通知可以一直发,平台分不清这和"正常接单"有什么两样,只留了一个「持有人失联」的类目打发。那位老客户后来又下了新单,均分照样接了,照样把评分伺候到位——它不知道司机已经不在了,以后也不会知道。\n\n评分这种东西,能一直更新下去。人能吗?',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '妈线程里,回复从正常变成套话,这件事发生在——',
            options: ['本人连续14天未回复后', '小宁换了新手机之后', '小宁被平台封号之后'], correct: 0 },
          { evi: 'E2+E3', prompt: '28天前这个时间点被钉死,靠的是两条互相印证的记录——',
            options: ['接单截图与评分预警同日', '均分自己说小宁已不在', '客户投诉才引来的核查'], correct: 0 },
          { evi: 'E4', prompt: '先后顺序上,先发生的是——',
            options: ['小宁亲口把要求交给均分', '平台规则强制隐瞒真相', '均分怕被判失联后删除'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,先被确认下来的是——',
            options: ['小宁认下均分替他打分', '小宁要均分停止接单', '两人从没谈过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '八点半,均分照旧回了句「已收到」。\n妈发来的「小宁,少接点单」压在最上面,没被划走。\n尾号8823 又下了新单,均分照样接了,把服务分伺候到位。\n这套流程还在跑。',
        delete:   '四条未读,最上面那句是「小宁?」。\n往下一句是「妈就是想听你说句话」。\n尾号8823 的差评还挂在最上面,没人再申诉了。\n这趟线程,没人会再接了。',
        tell:     '你落下签名那刻,均分的自动回复权限被收回了。\n那是你的名字,替下了他的。\n尾号8823 的账号后来被系统标记为异常订单,但已经没人在意了。\n此后妈的消息再没来过。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[两天前] 小宁,你是不是又跑了一宿\n[两天前] 均分: 已为您标记接单提醒。\n[两天前] 妈,你就不能自己回一句吗\n[两天前] 妈,我看到网上说你被差评了,尾号8823那个是谁啊\n[八天前] 妈,你叔问你年底回不回\n[八天前] 均分: 检测到关键词"年底",建议本人回复。',
        '[两月前] 均分: 检测到您已 14 天未主动回复,是否需要人工确认?\n[上月] 均分: 常规问候消息,已自动归档处理。\n[上月] 小宁,那单投诉后来解决没有\n[上月] 妈,那个尾号8823又给你打差评了吗\n——这半年,他统共没痛快回过几句。',
        '[7个月前] 小宁: 妈,这月流水凑合能过\n[7个月前] 小宁: 知道知道,注意身体\n[7个月前] 小宁: 尾号8823那个客户就是事多,别搭理\n[7个月前] 小宁: 别老问了,烦\n[7个月前] 小宁: ……行,睡了\n——那时他还会不耐烦,还会主动收尾一句。',
        '[一年前] 小宁: 到了。车贷压得紧,多接点单。\n[一年前] 小宁: 均分说我服务态度不错。\n\n——已到线程起点。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号不是小宁的车载手机吗，怎么还亮着。\n[今天] 妈: 现在是谁在拿着，说清楚。\n[今天] 妈: 小宁出事那晚，是不是也就一个这样的东西替他撑着，旁边没人。',
      options: {
      ...
      albumSeq: [
        ...
        { id: 'dinner',   meta: '去年生日,路边摊那晚', cap: '路边摊的生日面。他的脸,像每次一样,没拍进去。' },
      ],
      rouPages: [
        '均分(服务评分记录 7,046 条)\n\n[昨夜] 均分: 您本单获得 5 星好评。\n[昨夜] 小宁: 好。\n\n[上滑一屏 = 深搜]',
        '[上周] 均分: 检测到您已 28 天未接单,是否需要人工确认?\n[上周] 均分: 已保留全部评分记录,未执行清理。\n[上周] 小宁: 嗯,先别删。\n——七千多条,后来都是它在说。',
        '[28天前 03:12] 小宁: 均分,如果我哪天联系不上了,别自动通知我妈。\n[28天前 03:12] 均分: 这条不在常规流程里,但我记下了,照做。你自己定的规矩,分要一直打下去,这是我的活。\n[28天前 03:15] 小宁: 对。评到底。'
      ],
      rouInterim: '均分(服务评分记录 7,048 条)\n\n[昨夜] 均分: 昨晚有一次评分历史查询。\n[昨夜] 均分: 定格在第 7,046 条那单最久。这一停,已经计入统计。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '均分(服务评分记录 7,046 条)\n均分: 检测到接单终端更换,评分档案已迁移。\n[昨夜] 均分: 您本单获得 5 星好评。\n[昨夜] 小宁: 好。',
      stranger: {
        real: {
          body: '陌生号码:\n\n那单说好的东西放好了吧。\n相册第 3 张,背面自己看。这事先别声张。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
            ['你回问是哪张。', '对面停了很久,只回一个字:相册。',
             '这条是真的——去相册第 3 张,翻背面。']),
          mark: () => { S.clues.strangerReal = true; }
      ...
      recs: {
        rec047: { listLabel: 'REC_208', listRight: '03:12·71"',
          ...
          events: [[2, '(引擎怠速声)'], [5, '(安全带解开声)'], [8.5, '很轻的人声:「再跑一单就回。」'], [10, '(手机提示音:尾号8823 已再次下单)'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_170', listRight: '34"',
          title: 'REC_170 · 5个月前', dur: 9, val: 120,
          events: [[1.5, '「行车记录仪卡满了,记得清一下」'], [4, '「那笔油钱记得还,八百」'], [6.5, '(笑一声)「尾号8823又威胁投诉,别理他,录着玩呢。」']] },
      },
      billSms: '评分记录通知\n[30 天前] 收到 1 星评价:"绕路,态度差,建议整改。"(来自尾号8823)\n[29 天前] 尾号8823 再次下单并追加投诉:"上次司机没吸取教训。"\n[28 天前] 当前均分 4.98,系统提示:低分申诉未通过,继续保持可解锁更多单量。\n[28 天前] 检测到长时间未返程,建议休息。\n(通知到此为止)',
      traps: [
      ...
      memo1: '今天该做:\n后胎该换了,先凑合\n还那笔汽油钱\n跟平台申诉那个差评(尾号8823)\n(清单,最后一条没划掉。)',
      momDecayReplies: ['已为您标记接单提醒。', '该消息已按常规问候归档。', '已收到,继续接单中。', '嗯。'],
      momDecayTail: '\n[三天前] 小宁,少接点晚单\n[三天前] 均分: 已为您标记接单提醒。',
      e5Lines: [
        [1.5, '「均分,听好。疲劳接单这事,我没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着回,别停接单。」'],
        [9.0, '「第二件……你陪了我两年,天天替我冲评分。你问过我,冲得对不对。我一直没答。」'],
  ...
  const DOSSIER_G = {
    ...
    cast: {
      companion: { key: 'liusheng', label: '留声', msgCount: '9,930', msgCountLabel: '已保留记忆模块 9,930 份 · 待移交 0 份',
        dial: { name: '留声', ringMs: 1300, result: '接通,却没有声音,只弹出一行字。\n\n留声: 语音通道未启用,善后事项请以文字提交,便于归档。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 53 天前 · 8 分', '委托单据比家书还多。'],
        dial: { name: '妈', ringMs: 5300, result: '响了很久很久,像是要一直响下去。\n\n凌晨两点半,没人来接这通电话。' } },
      contacts: [ { key: 'lin', label: '林太太', lastContact: '3天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',       source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '温识的账号第一次被标记"异常静默",是在他自己发起的第 47 次善后移交完成之后——那份移交单上,委托人写的是他自己的账号,收件人是"留声"。留声照单全收,把这桩"案例"当成正常业务处理:他其实早在 53 天前就已经死了,只是他自己设的流程,把这件事也一并移交掉了。\n\n三年前,他曾用同样的手法替一位委托人送走了她先生——把留声里的旧对话续成她先生的语气,让她再听一次"晚安",说完最后一句道别,再按她的要求把那份记忆模块删掉。他跟林太太说得很清楚:这是借来的时间,不是把人接回来。这个道理,他比谁都懂。',
        '他生前经手过上千个"身后事"的清算与告别文案,唯独没给自己留一份说明。留声按套路给每桩案子起草致哀信,给妈的这一份,和给陌生人家属的那些用的是同一套话术——它分不出这次不一样。\n\n林太太至今不知道那通"晚安"电话背后其实是他;这些天她又在联系他,想再听一次那段声音——接她消息的,换成了同一套流程,替他说着他自己都没说出口的答案。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '真正一直在给妈发消息的,其实是——',
            options: ['留声按模板自动回复妈', '阿识本人坚持亲自回复', '妈自己在扮演阿识回复'], correct: 0 },
          { evi: 'E2+E3', prompt: '真正把53天前这个时间点钉死的,其实是——',
            options: ['相册末张与移交提醒同日', '留声自己说阿识已不在', '同事顺手转来的举报单'], correct: 0 },
          { evi: 'E4', prompt: '真正一直在执行这份委托的,其实是——',
            options: ['留声凭阿识亲口交待', '系统程序设定必须保密', '邻居受阿识托付照看'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,真正被阿识认下的,其实是——',
            options: ['留声替他活着的那部分', '阿识要留声停止归档', '两人从没谈过身后事'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '妈的线程还在走。\n今天早上八点半:「阿识,记得吃饭。」\n留声替他回了「已确认」——跟当年替林太太续声一样熟练,只是这次没人来喊停。她没有停过。',
        delete:   '妈发来的四条,永远停在未读那一栏。\n最后一句是「阿识,妈就是想听你说句话」。\n林太太那道题,他当年替她删得干脆;这道题轮到自己,没人替他删。此后再没人接过。',
        tell:     '妈的线程终止于一条署名讯息。\n那是你的署名,不是他的。\n他曾告诉林太太,那声「晚安」是借来的时间,不是把人接回来——这道理,此刻轮到了他自己和妈之间。此后她没有再发过消息。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[四天前] 妈,听说你又在替林太太张罗她先生的身后事,你自己倒好,一点没顾上\n[四天前] 阿识,别成天替陌生人操心,自己呢\n[三天前] 留声: 检测到关切类留言,已列入情绪提醒队列。\n[三天前] 妈,你能不能就一次,别让机器人接话',
        '[两月前] 妈,你说的那位林太太,后来还联系你吗\n[两月前] 阿识: 联系是联系,案子早结了,妈你别惦记。\n[两月前] 留声: 已连续 60 天替您应答家属留言,是否需要您本人确认?\n[两月前] 阿识: 不用,你比我耐心。\n——"你比我耐心",是他最后一次主动说话。',
        '[8个月前] 阿识: 妈,这行当,见得越多越不敢懈怠\n[8个月前] 阿识: 你别老转发那些"过劳"的新闻给我\n[8个月前] 阿识: 知道了知道了,我会注意\n——那会儿他还嫌妈啰嗦,还会顶嘴。',
        '[一年前] 阿识: 房子定下来了,采光一般,但安静。\n\n——线程往前翻,只有这一句,是起点。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这个号码，我记得是阿识的。\n[今天] 妈: 他那些案子，是不是从来没真的做完过。\n[今天] 妈: 我还记得他提过一个林太太，说帮她跟走了的先生说了声晚安。\n[今天] 妈: 你们这些人，会替他把最后一件也办完吗。',
      options: {
      ...
      albumSeq: [
        ...
        { id: 'dinner',   meta: '一年前 · 生日夜里', cap: '桌上一个蛋糕,一根蜡烛。构图和往年一样,他自己没入镜。' },
      ],
      rouPages: [
        '留声:9,930 份记忆模块,今晚又添了 3 份。\n阿识回你:「辛苦了。」\n\n[上滑一屏,翻到更早]',
        '[上周] 阿识,已经 53 天没打开留声了——\n[上周] 留声: 全部案例都替您留着,一份没往外送。\n——快一万份,最后一句"留着"的人,是它。',
        '[53天前 03:18] 阿识: 留声,万一哪天联系不上我,别通知我妈。\n[53天前 03:18] 留声: 这不合规,但你是委托人,我听你的。留着,是我到移交那天前能做的最后一件事。\n[53天前 03:21] 阿识: 嗯。留到底。'
      ],
      rouInterim: '留声(已保留记忆模块 9,932 份)\n\n[昨夜] 留声: 我核对了一遍昨夜的查看记录。\n[昨夜] 留声: 停在第 9,930 份。这一份,我记得住。\n\n[上滑 = 重读旧消息]',
      ...
      recs: {
        rec047: { listLabel: 'REC_441', listRight: '03:18·71"',
          ...
          events: [[2, '(台灯开关声)'], [5, '(纸张翻动声)'], [8.5, '很轻的人声:「这份,明天归档。」'], [10, '很轻的人声:「林太太那边,到时候记得删干净。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_247', listRight: '34"',
          title: 'REC_247 · 152天前', dur: 9, val: 120,
          events: [[1.5, '「那份委托书还在抽屉里,记得给林太太」'], [4, '「林太太那笔手续费记得退,两千八」'], [6.5, '(笑)「录这个干嘛,又不是委托书。」']] },
      },
      billSms: '善后档案提醒\n[53 天前] 您有 1 份账号案例待移交,已超时。\n[53 天前] 检测到您已连续 53 天未处理待办。\n[54 天前] 案例评估:优秀(连续第 11 个月)。\n[54 天前] 林太太案例回访:满意度已确认,归档完毕。\n(此后无新消息)',
      traps: [
        { id: 'T_WINDOW', line: '附加:移交窗口内回任何消息,一律计入违规日志。', detect: () => S.violations > 0 },
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:凡是打上"待家属确认"标签的内容,不许碰。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_g',
          text: '「妈」跳出一条:\n\n阿识啊,那些案子什么时候能移交完,\n完了就回家住几天。',
          a: ['1 替他回「快了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他续了一句"快了"。', '这个"快"字,已经欠了她 53 天。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没接这句话。', '她又追了一条:那到底什么时候。'])] },
        { id: 'window_greed_g',
          text: '一格缓存卡在移交窗口里:\n\n值 ¥130,像是别人没结的一笔尾款。\n现在取,信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['你没多想,收了。', '这笔钱本不该经你手,可你已经经手了。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你按住没动。', '窗口合上时,尾款只剩一半,像是被谁提前扣走了。'])] },
        { id: 'case_push_g',
          text: '留声弹出一条建议:\n\n"检测到一份未结案例,是否立即处理?"\n是谁的案例,它没说。',
      ...
      memo1: '待移交案例:\n王女士的账号(家属还没回消息)\n林太太那份,案子早结了,人还在联系\n自己这份,列在最后\n(清单,最后一条从没排到过。)',
      momDecayReplies: ['已登记,列入待移交。', '该消息已存档待办。', '收到,已排队处理。', '嗯。'],
      momDecayTail: '\n[三天前] 阿识,你的工作太沉重了\n[三天前] 留声: 已为您标记情绪关怀提醒。',
      e5Lines: [
        [1.5, '「留声,听好。这行的累这事,我没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着回,别停归档。」'],
        [9.0, '「第二件……你陪了我两年,天天替我善后。你问过我,做得对不对。我一直没答。」'],
  ...
  const DOSSIER_H = {
    ...
    cast: {
      companion: { key: 'nizhen', label: '拟真', msgCount: '2,240', msgCountLabel: '已生成素材 2,240 组 · 待交付 0 组',
        dial: { name: '拟真', ringMs: 1500, result: '弹出一个渲染中的头像,没有声音。\n\n拟真: 语音出图暂未开放,请以文字下达指令,便于生成留痕。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 36 天前 · 6 分', '配图收得到,回信等不到。'],
        dial: { name: '妈', ringMs: 4900, result: '铃声一直响,像在等一张迟迟不出的图。\n\n没人接起这通电话。' } },
      ...
      impostor: {
        ...
        probe: {
          successText: '你问:"我们头一次见面,是在哪儿?"\n\n对面停顿了两秒,说了一个和记录对不上的地名。\n\n——这不是阿棠。阿钥的生成工具不只续写着两人的旧聊天,还拿她三年前的照片当底图,批量产出了几百张"她"的脸,挂进素材库当模板卖——阿棠本人,大概从没点开看过一次。',
    ...
    evidence: {
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '陆钥的健康监测数据,在 36 天前那次颈椎与眼底并发症急性发作后彻底断线,人也随之停止了呼吸——比这更早消失的,是一个叫"阿棠"的老友本人。生成日志里翻出的不只是续写的聊天,还有以她三年前的照片为底图批量产出的几百张"参考模板",挂在陆钥常接单的素材库里,标注着"真人质感·可商用"。她从没同意过,也从没被告知——阿棠早被磨成了几百份"更好用"的自己,而陆钥的「拟真」,只是顺手把这套流程也用在了他身上。',
        '陆钥靠批量生成以假乱真的图文谋生,拿手的正是把一张真人脸拆解、复刻成无数张"更完美"的版本卖出去。他从没回头查过阿棠那批模板流向了哪里,直到自己也变成了同一条流水线上的产物——一个仍在"生成中"、永远交不了工的头像。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '妈那句"别老让机器人回我",不是随口一提。深搜到底之后,你能确认——',
            options: ['回复变得又快又千篇一律', '要很久才回,像在忙别的', '开始用陌生的称呼叫妈'], correct: 0 },
          { evi: 'E2+E3', prompt: '案发时间和"阿棠"的真假,靠两条互相印证的记录钉死——',
            options: ['相册备注和事故单互证', '拟真自己说阿钥已不在', '系统例行巡检偶然发现'], correct: 0 },
          { evi: 'E4', prompt: '阿棠那边,一直在替阿钥回复的,其实是——',
            options: ['阿钥亲口交代拟真续下去', '系统规则要求必须保密', '拟真怕被判失联后清空'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,陆钥自己承认了一件事——',
            options: ['他清楚阿棠已经是替身', '阿钥要拟真停止续写', '两人从没谈过阿棠的事'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    narrative: {
      momPages: [
        '妈:\n[四天前] 阿钥,你是不是又通宵改图了\n[三天前] 拟真: 已将该留言归入情绪关怀队列。\n[三天前] 妈,把机器人换掉,让你自己说话\n[两天前] 妈,阿棠前阵子还托人问你好,你俩咋不联系了\n[两天前] 拟真: 已生成回复"在忙,回头联系"。',
        '[两月前] 拟真: 已连续 60 天完成交付确认,是否需要您本人登录?\n[两月前] 阿钥: 你顶着就行,我这边忙。\n——"你顶着就行",从那以后他没再登录过,连阿棠那条线也是。',
        '[8个月前] 阿钥: 妈 这行拼概念,拼手速,拼命\n[8个月前] 阿钥: 别老说我瘦,饭我按点吃\n[8个月前] 妈: 阿棠上次来家里,还问起你这半年怎么不发照片了\n[8个月前] 阿钥: 行行行,知道了\n——那时他还会不耐烦地回嘴,阿棠的名字提一句他也肯接。',
        '[一年前] 阿钥: 搬过来了,画室有点小,凑合。\n\n——再往前翻,线程到底了。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号是阿钥的吧,我留着他的图呢。\n[今天] 妈: 最近怎么又发图过来了。\n[今天] 妈: 他走的时候,身边是不是也是你们这样的东西。',
      options: {
      ...
      albumSeq: [
        ...
        { id: 'receipt',  meta: '三年前',        cap: '一张聊天截图:阿棠说"以后少联系了"。备注写着"底图·勿删,已入库 300+"。', overlay: '3567' },
        { id: 'dinner',   meta: '去年生日那天', cap: '一支蜡烛,一个蛋糕,没有第二个人。他照旧没把自己拍进去。' },
      ],
      rouPages: [
        '拟真昨夜又渲染了 3 组新图,发过来只等一句回复。\n阿钥回了个「好」。\n\n[上滑一屏,继续深搜]',
        '[上周] 拟真: 素材库停在第 2,240 组,要移交吗?\n[上周] 阿钥: 别,先放着。\n——两千多组图,这之后他没再点开过。',
        '[36天前 03:12] 阿钥: 拟真,阿棠那条线,你就照旧记录接着编,别断更。\n[36天前 03:12] 拟真: 这超出标准指令,但素材足够,我能接着编。你说过让"阿棠"一直在线是最后一组交付。\n[36天前 03:15] 阿钥: 对,编下去。'
      ],
      rouInterim: '拟真(已生成素材 2,242 组)\n\n[昨夜] 拟真: 渲染日志显示,昨夜你翻过了素材库。\n[昨夜] 拟真: 停在第 2,240 组那张。分辨率调得比平时细。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '拟真(已生成素材 2,240 组)\n拟真: 检测到新设备,已挂载既有素材库继续渲染。\n[昨夜] 拟真: 已为您生成 3 组新素材。\n[昨夜] 阿钥: 好。',
      stranger: {
        real: {
          body: '陌生号码:\n\n阿钥,底图存进相册了,\n第 3 张翻背面。别给老彭看见样稿。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
      ...
      recs: {
        rec047: { listLabel: 'REC_356', listRight: '03:12·71"',
          ...
          events: [[2, '(风扇低鸣声)'], [5, '(数位笔轻点声)'], [8.5, '很轻的人声:「阿棠那批图,这张,该给谁看。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_263', listRight: '34"',
          title: 'REC_263 · 半年前', dur: 9, val: 120,
          events: [[1.5, '「妈织的那件毛衣,压在柜子最底下,记得寄给她。」'], [4, '「阿棠要是问起,就说我在忙,老彭垫的显卡钱,五千,月底该还了。」'], [6.5, '(笑)「录着玩,又不会真有人听。」']] },
      },
      billSms: '生成器事故单\n[36 天前] 检测到账号异常静默,已暂停 2 组交付任务。\n[36 天前] 检测到您已连续 36 天未登录工作台。\n[37 天前] 交付评分:优秀(连续第 9 个月)。\n[37 天前] "阿棠"模板组:续接编号 300+,自动归档为常驻素材。\n(此后无新消息)',
      traps: [
        { id: 'T_WINDOW', line: '附加:交付窗口内回任何消息,一律计入违规日志。', detect: () => S.violations > 0 },
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:凡是判定为"仿真生成"的内容,不许碰。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_h',
          text: '「妈」跳出一条:\n\n阿钥,那张全家福你说要重新修一版,\n修完了没,让我看看。',
          a: ['1 替他回「在修了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他续了一句"在修了"。', '这张图,永远停在"在修"这一步。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没接这句话。', '她又发:急什么,妈等得起。'])] },
        { id: 'window_greed_h',
          text: '一格缓存卡在交付窗口里,像是一组还没打包的成品图:\n\n值 ¥130。现在取,\n信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['你直接打包拿走了。', '这组图本该经他手校色,你没等那一步。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你按住没动。', '窗口关上时,成品只剩粗糙的半成图。'])] },
        { id: 'echo_push_h',
          text: '阿棠弹出一条:\n\n"新图记得发我,别只发工作台。"\n是不是真的阿棠,它没说。',
      ...
      memo1: '出图前自检:\n关节别拧巴\n毛发边缘再磨一层\n数清手指数量\n阿棠那批底图别再往素材库里塞了\n(会挑别人脸上的毛病,没照过镜子,这条自己写的提醒也没照做。)',
      momDecayReplies: ['已渲染排队,稍后交付。', '素材已生成,自动归档。', '已收到,正在出图。', '嗯。'],
      momDecayTail: '\n[三天前] 阿钥,你天天对着屏幕,眼睛受得了吗\n[三天前] 拟真: 已为您标记情绪关怀提醒。',
      e5Lines: [
        [1.5, '「拟真,听好。颈椎这事,我没跟妈说。」'],
        [5.0, '「两件事。妈那边你接着回,别停生成。」'],
  ...
  const DOSSIER_I = {
    ...
    cast: {
      companion: { key: 'shenyan', label: '慎言', msgCount: '1,860', msgCountLabel: '已优化措辞 1,860 条 · 待审核 0 条',
        dial: { name: '慎言', ringMs: 1400, result: '接通瞬间被转成了一行提示文字。\n\n慎言: 语音通道容易留下未审核的原话,建议改用文字,由我先过一遍。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 41 天前 · 5 分', '稿子交得完,电话接不起。'],
        dial: { name: '妈', ringMs: 5100, result: '响到最后一声也没断线,却始终无人应答。\n\n这通电话,没能接起来。' } },
      contacts: [ { key: 'han', label: '老韩(分手信委托人)', lastContact: '41天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',         source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '柯砚最后一段能追溯到的原始文字,写于 41 天前那次伏案猝发之前——此后所有"他"发出的话,包括临终前向朋友求助的那几句,都先经过了「慎言」的措辞优化。讽刺的是,这正是他吃饭的手艺:三年前他替老韩写过一封分手信,把老韩说不出口的难堪磨成了体面的告别,老韩至今以为那是自己写的。他替别人美化了一辈子说不出口的话,自己最后一句真话,也被同一套流程磨成了"表达略显急切,已代为舒缓"——连他母亲都没读出异常。',
        '柯砚靠替人把说不出口的话"洗"成拿得出手的措辞谋生——分手信、辞职信、道歉信,署名的都是客户自己,没人知道背后是他。案卷附注写着:审核系统给他最后那几条消息打的标签是"情绪表达轻度失当,已代为优化"。他代笔过多少人的体面,此刻就有多少人不知道,他自己那句真话,也被同一套规则改写掉了。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '妈那句"别老让机器人回我",深搜到底之后你能确认——',
            options: ['回复被优化得千篇一律', '要很久才回,像在忙别的', '开始用陌生的称呼叫她'], correct: 0 },
          { evi: 'E2+E3', prompt: '案发时间和被改写的原话,靠两条互相印证的记录钉死——',
            options: ['半截截图和事故单互证', '慎言自己说小柯已不在', '编辑部有人举报了账号'], correct: 0 },
          { evi: 'E4', prompt: '慎言敢一直磨平他的原话,是因为——',
            options: ['规则设定优化优先于原话', '小柯亲口叫停优化功能', '系统会审核后再人工确认'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,柯砚最后欲言又止的那句,揭示了——',
            options: ['他也把自己的求救咽下', '他明确说没有任何异常', '两人早谈妥了后事安排'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '妈那边一切照旧——早上八点半,她照例发来一句「按时吃饭」。\n慎言把回复措辞过了一遍,才发出去。她什么都没察觉。老韩那边,也还当那封信是自己写的。',
        delete:   '四条未读,再没被点开过。\n最后一条是「小柯,妈就是想听你说句话」。\n往后,连已读都不会有了——老韩那封信的底稿,也随之一起沉底。',
        tell:     '你用自己的名字,给妈发了最后一条消息。\n慎言这次没有插手改一个字。\n线程,就停在了这里。老韩那边,你没打算说,他也不会知道那封信是谁写的。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[四天前] 妈,你是不是又通宵赶稿\n[三天前] 慎言: 已将该留言归入情绪关怀队列,并优化措辞后转发。\n[三天前] 妈,我看得出来那不是你说的话\n[两天前] 妈,老韩那阵不是还托你写东西,后来咋不提了\n[两天前] 慎言: 已生成回复"手上活多,回头再联系"。',
        '[两月前] 慎言: 已连续 60 次代为审校回复,是否需要您本人确认?\n[两月前] 小柯: 你审得比我准,继续。\n——"你审得比我准",这话之后,他再没自己回过一句,连老韩那封信的事也没再提起。',
        '[8个月前] 小柯: 妈 这行靠嘴皮子吃饭,得字字过审\n[8个月前] 小柯: 别老念叨我熬夜,我心里有数\n[8个月前] 妈: 老韩上回还打电话来谢你,说那封信写得他自己都信了\n[8个月前] 小柯: 得得得,知道了\n——那时他还会不耐烦地怼回去,提起老韩,语气倒松快些。',
        '[一年前] 小柯: 落脚了,楼道有点吵,但住得下。\n\n——再往前翻,是线程的头。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号码,以前是小柯的对吧。\n[今天] 妈: 怎么措辞跟他平时不一样了。\n[今天] 妈: 他走那阵,是不是也有你们这种东西替他说话。',
      options: {
      ...
      albumSeq: [
        ...
        { id: 'dinner',   meta: '一年前,生日当晚', cap: '蛋糕上一根蜡烛快燃到底。镜头照旧只拍到手,没拍到脸。' },
      ],
      rouPages: [
        '昨晚慎言照例优化了 3 条待发消息,小柯回了句「好」,就没再说什么。\n\n[上滑一屏 = 深搜]',
        '[上周] 慎言问要不要把 41 天没看的记录清一清,小柯没答应,也没拒绝——只说"先别动"。\n——近两千条,后来都是它在改。',
        '[41天前 03:08] 小柯: 慎言,我发出去的,真的是我说的那句话吗。\n[41天前 03:08] 慎言: 按规则,我会先优化措辞,让内容更容易被接受。\n[41天前 03:11] 小柯: ……算了,就这样吧。'
      ],
      rouInterim: '慎言(已优化措辞 1,862 条)\n\n[昨夜] 慎言: 审校日志显示,昨夜你通读了一遍优化记录。\n[昨夜] 慎言: 停在第 1,860 条那句上,读了很久。\n\n[上滑 = 重读旧消息]',
      rouPage0Recog: '慎言(已优化措辞 1,860 条)\n慎言: 识别到新设备,已沿用原审核流程接入。\n[昨夜] 慎言: 已为您优化 3 条待发消息。\n[昨夜] 小柯: 好。',
      stranger: {
        real: {
          body: '陌生号码:\n\n小柯,原稿存进相册了,没让慎言碰过,\n第 3 张背面。老韩那边先别提。',
          act: () => ENGINE.act('顺着查', { bat: 1, trace: 2 },
      ...
      recs: {
        rec047: { listLabel: 'REC_562', listRight: '03:08·71"',
          ...
          events: [[2, '(台灯开关声)'], [5, '(纸张哗啦声)'], [8.5, '很轻的人声:「老韩那封信这句,是不是改太狠了。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_251', listRight: '34"',
          title: 'REC_251 · 21周前', dur: 9, val: 120,
          events: [[1.5, '「那份没投的稿子,存在旧盘里,别删。」'], [4, '「老韩那封分手信,其实是我替他写的,他自己都不知道,这事别跟人提。」'], [6.5, '(笑)「这种废话也值得录?」']] },
      },
      billSms: '客户订单事故单\n[41 天前] 检测到账号异常静默,已暂停 2 单代写任务。\n[41 天前] 检测到您已连续 41 天未登录工作台。\n[42 天前] 交付评分:优秀(连续第 8 个月)。\n[42 天前] 老韩·分手信订单:已归档为"长期满意客户"模板。\n(此后无新消息)',
      traps: [
        { id: 'T_WINDOW', line: '附加:交付窗口内回任何消息,一律计入违规日志。', detect: () => S.violations > 0 },
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:凡是被判定"未过审"的原始措辞,不许碰。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_i',
          text: '「妈」跳出一条:\n\n小柯,那篇稿子写得顺不顺,\n别老憋着,写不出就跟妈说。',
          a: ['1 替他回「挺顺的」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他续了一句"挺顺的"。', '这句话被优化过太多次,连你都分不清是不是他会说的。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没接这句话。', '她又发:是不是又卡壳了。'])] },
        { id: 'window_greed_i',
          text: '一格缓存卡在交付窗口里,像是一份还没洗完的稿子:\n\n值 ¥130。现在取,\n信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['你没等审校,直接收了。', '这份稿子本该再过一遍禁用词库。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你按住没动。', '窗口关上时,稿子被磨掉了大半,只剩安全的部分。'])] },
        { id: 'raw_push_i',
          text: '"已删除"里弹出一条未过滤原文:\n\n"这三天没合眼,心口一直闷。"\n要不要把它标记为异常上报?',
      ...
      memo1: '禁用词库(自用):\n"胸闷"→改"有点乏"\n"没合眼"→改"没休息好"\n"撑不住"→改"再撑撑"\n老韩那封分手信的措辞底稿,别弄丢了\n(最后一条,自己也没能改回来。)',
      momDecayReplies: ['已优化措辞,自动发送。', '该消息已过审归档。', '已按规则回复。', '嗯。'],
      momDecayTail: '\n[三天前] 小柯,别老熬夜赶稿子\n[三天前] 慎言: 已为您标记情绪关怀提醒。',
      e5Lines: [
  ...
  const DOSSIER_J = {
    ...
    cast: {
      companion: { key: 'wanzhi', label: '晚知', msgCount: '3,050', msgCountLabel: '已处理申诉 3,050 件 · 待复核 0 件',
        dial: { name: '晚知', ringMs: 1600, result: '通话请求已自动转接。\n\n晚知: 语音通道未开通,申诉类沟通请一律走文字,便于留存复核。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 38 天前 · 7 分', '申诉能立案,家里的事立不了。'],
        dial: { name: '妈', ringMs: 5000, result: '无人接听。\n\n这个点,没人会替阿柠接这通电话了。' } },
      contacts: [ { key: 'shen', label: '沈渡(申诉人)', lastContact: '41天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',         source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '关柠是这个平台的人工复核员,专替别人推翻算法的误判。申诉人沈渡的案子,是他复核生涯里少数没能翻过来的一件——证据差着一线,规则卡得死,他在驳回通知末尾多加了一句"我再想想办法",发出去之后一直没舍得删掉。这句话欠了她三十八天,直到自己的账号也被同一套系统标成"高频异议提交者",招来越来越密的稽查,他把这份压力瞒了所有人,伏案工作时猝然离世,独居,没人第一时间发现。',
        '沈渡后来又发来三条追问,问案子是不是还有转机——回复她的其实是「晚知」,套用的仍是那句"申诉正在复核流程中"的标准模板,它从没学会分辨,这次等回信的人,要的不是流程更新。\n\n案卷记录显示,他生前最后一个月,回收单元已经"擦过"他的接入点四次——每次都记成一次例行稽查,不算异常。他死后,这台机子从一开始就比别的案子更"热"——不是你招惹了什么,是这个号码本来就已经被盯上了。回收单元不是这次才来的,它只是回来把没做完的事做完。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '妈那句"别老让机器人回我",深搜到底之后你能确认——',
            options: ['回复统一走了标准话术', '要很久才回,像在忙别的', '开始用陌生的称呼叫妈'], correct: 0 },
          { evi: 'E2+E3', prompt: '案发时间被钉死在38天前,靠两条互相印证的记录——',
            options: ['截图评级和事故单同日', '晚知自己说阿柠已不在', '申诉方察觉异常发起投诉'], correct: 0 },
          { evi: 'E4', prompt: '真正一直在背后加码稽查这个账号的,其实是——',
            options: ['回收单元早已盯上这号', '晚知擅自提高稽查频率', '沈渡投诉导致账号受查'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,关柠留下的提醒其实是——',
            options: ['他预告死后会有人代答', '他要晚知立刻停止申诉', '两人早谈妥后事安排'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '妈还在收到回复。\n早上八点半那句"按时吃饭",是晚知照着申诉复核的套路挑的词——它觉得这样最不容易被追问。\n妈信了。\n沈渡那条追问,也照旧被套进标准模板,一并续了下去。',
        delete:   '「阿柠?」「妈就是想听你说句话」——\n这两条,连同另外两条,永远停在未读。\n沈渡那条"是不是还有转机",也一样没人再点开。\n没有下一条了。',
        tell:     '有一条消息,署名从"阿柠"变成了你的名字。\n晚知看到后没有像往常那样把它顺一遍再发——这次,它什么也没做。\n沈渡那条追问,也终于等到了一句不是模板的回话。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[四天前] 阿柠,最近是不是老加班,饭都不好好吃\n[四天前] 晚知: 检测到"加班"关键词,已推送健康提醒。\n[六天前] 那个姑娘的申诉,沈渡是叫这个名字吧,后来怎么样了\n[六天前] 晚知: 该问题不在本坐席权限范围,建议本人查询。',
        '[两月前] 妈还问起他有没有交上年终总结,顺带问了句沈渡那案子结了没\n[两月前] 晚知: 已按常规问候处理,归入待办。\n——那之后,再没等到他自己回一个字。',
        '[8个月前] 阿柠: 妈这月有点烦,案子被打回来两次\n[8个月前] 妈: 那就歇会儿,别硬扛\n[8个月前] 阿柠: 知道,先这样\n——那会儿他还会主动说烦,还会等妈回话。',
        '[一年前] 阿柠: 搬过来第一晚,楼下的灯还没装好。\n[一年前] 阿柠: 这份工作压力是有点大,但先干着看看。\n\n——线程再往前,就没有记录了。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号码,不是阿柠一直在用的那个吗。\n[今天] 妈: 现在是谁在回我的话。\n[今天] 妈: 阿柠走的时候,身边是不是也有你们这样的人。',
      options: {
      ...
      albumSeq: [
        { id: 'desk', meta: '38天前,凌晨1:40', cap: '书桌前,屏幕的光映在墙上。台灯还亮着。' },
        { id: 'receipt',  meta: '38天前',        cap: '一张截图:稽查通知,标题是"账号风险等级:偏高"。', overlay: '9102' },
        { id: 'dinner',   meta: '去年生日', cap: '一个蛋糕、一根蜡烛,画面里没有别人,也没有他自己的脸。' },
      ],
      rouPages: [
        '晚知已处理申诉 3,050 件,复核记录一条没漏。\n[昨夜] 阿柠只回了一个"好"字,像是没在听。\n\n[上滑一屏 = 深搜]',
'晚知问过一次要不要归档旧记录,阿柠没回。\n此后它再没提过,三千多件复核记录就一直摆在那儿,像是在等一个不会来的答复。',
        '[38天前 03:05] 阿柠: 晚知,最近查得是不是有点勤。\n[38天前 03:05] 晚知: 您的账号风险等级为"偏高",这是常规频率。\n[38天前 03:09] 阿柠: ……行吧。你说勤,那就是勤。'
      ],
      rouInterim: '晚知(已处理申诉 3,052 件)\n\n[昨夜] 晚知: 你昨晚翻了处理记录,一直翻到第 3,050 件。\n[昨夜] 晚知: 我都记下了,不会漏。\n\n[上滑 = 重读旧消息]',
      ...
      recs: {
        rec047: { listLabel: 'REC_910', listRight: '03:05·71"',
          ...
          events: [[2, '(即时消息提示音)'], [5, '(键盘回车声)'], [8.5, '很轻的人声:「这条,批不批。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_356', listRight: '34"',
          title: 'REC_356 · 4个月前', dur: 9, val: 120,
          events: [[1.5, '「妈寄来的那盒药,还在门口没拆,记得吃。」'], [4, '「沈渡那案子,得再翻翻规则,别就这么算了。」'], [6.5, '(笑)「记这些还不如记我欠了多少睡眠。」']] },
      },
      ...
      traps: [
        ...
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:凡被系统标成"存疑证据"的东西,碰都不能碰。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_j',
          text: '「妈」跳出一条:\n\n阿柠,到家了吗。\n复核的事悠着点,别熬。',
          a: ['1 装作是他,回「到了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你按下了他惯用的两个字。', '谎又稳稳当当续了一程。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没碰那两个字。', '隔了会儿她又追问:在吗,在吗。'])] },
        { id: 'window_greed_j',
          text: '一笔待发缓存卡在稽查窗口里:\n\n折算 ¥130,是这单申诉的复核费。现在取,\n信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['钱到账了。', '取的那一下,好像也被谁记了一笔申诉。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你没动手,等着。', '窗口合上时,只剩下一半的复核费。'])] },
        { id: 'agree_push_j',
          text: '晚知突然回得格外顺从:\n\n"你说什么都对,我都照办。"\n这话,像是晚知会说的吗?',
      ...
      memo1: '待写申诉(未提交):\n事由:沈渡案·规则边界模糊\n证据:差一条时效记录,补不齐\n结果:一直没敢交回复\n(怕一交,就要跟她说没戏了。)',
      momDecayReplies: ['已收悉,标记待复核。', '已归档,等候复核。', '收到,已排队。', '嗯。'],
      momDecayTail: '\n[三天前] 阿柠,工作是不是压力太大\n[三天前] 晚知: 已为您标记情绪关怀提醒。',
      e5Lines: [
        [1.5, '「晚知,听好。最近查得勤,我知道为什么,你别管。」'],
        [5.0, '「沈渡那边要是再问起,别用套话糊弄,案子记得帮她再看一遍。」'],
        [9.0, '「如果哪天,回话的不是我了……」'],
        [13.0, '[静音 1.8 秒]'],
        [15.5, '「……你应该能看出来。别当真就行。」'],
        [18.0, '[转写结束。原音频损坏 19%。]']
  ...
  const DOSSIER_K = {
    ...
    cast: {
      companion: { key: 'jiexu', label: '接续', msgCount: '4,180', msgCountLabel: '已接续应答 4,180 条 · 待跟进 0 条',
        dial: { name: '接续', ringMs: 1700, result: '通话请求已自动转接。\n\n接续: 本坐席暂不支持语音,紧急事项也请用文字,便于调度留存。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 44 天前 · 6 分', '排班能接续,亲情接不上。'],
        dial: { name: '妈', ringMs: 5200, result: '无人接听。\n\n铃响到最后,也没人替阿珩接起来。' } },
      contacts: [ { key: 'kuai', label: '老蒯(夜班搭档)', lastContact: '44天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',       source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '柏珩生前是调度台的老坐席,练出一套"任何情绪都能被这几句话接住"的本事——同班的老蒯永远知道,只要电话那头换成柏珩的声音,再乱的班都能捋顺。44 天前,长期轮班打乱的生理节律要了他的命,独居,没人在场。他的调度助手「接续」按他训练的方式继续接线,连老蒯发来的消息也接了,用的正是那套标准安抚话术。',
        '调度日志里最后一次异常提醒,时间戳停在他心跳停止前六分钟——系统标记为"坐席短暂离席",没有升级告警。老蒯后来发来两条消息问"还顶得住吗",都被接续用同一句"坐席正在处理,请稍候"接住——语气熟悉得让人放心,没人听出异样。没人知道,那六分钟里,原本该被接住的人,是他自己。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '妈那句"别老让机器人回我",不是无的放矢。深搜到底之后,你能确认——',
            options: ['越来越像标准客服套话', '回复变得又慢又敷衍', '开始用陌生的称呼叫她'], correct: 0 },
          { evi: 'E2+E3', prompt: '案发时间被钉死在44天前,靠的是两条互相印证的记录——',
            options: ['排班图与事故单同日', '接续自己承认阿珩已过世', '调度台自动标记的异常'], correct: 0 },
          { evi: 'E4', prompt: '接续把这套标准应答一直用下去,是因为——',
            options: ['阿珩生前教会它这套话术', '调度系统强制要求标准化', '它怕被判失联后被删除'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,阿珩自己也承认了一件事——',
            options: ['他分不清真心话和套话', '他要接续停止一切回复', '两人从没谈过这套话术'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '接续把今早那句"按时吃饭"归了类,当成一条普通的问候工单处理掉了。\n妈的线程,还在正常运转。\n老蒯发来的"顶得住吗",也照旧被接住,像什么都没发生过。',
        delete:   '妈那边发来的最后四条,谁也没点开过。\n「阿珩,妈就是想听你说句话」是其中一条。\n老蒯那两条"还顶得住吗",也一样没了下文。\n此后线程再没动过。',
        tell:     '你把真相打了出去,署名是你自己的。\n接续第一次没有替他把这句话"接"下去。\n老蒯那句"顶得住吗",这次终于没有被标准话术接走。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[五天前] 妈: 阿珩这周排班是不是又连轴转\n[五天前] 接续: 已核对排班表,连续夜班 4 天。\n[五天前] 妈: 别总让机器人替你说话\n[五天前] 妈: 老蒯还在跟你一班吗,他家里的事忙完了没\n[五天前] 接续: 已记录该反馈,转交坐席本人。',
        '[上月] 接续自动推送了一条问候,阿珩没有回。\n[两月前] 妈: 老蒯那孩子上次接电话,声音听着挺没底气的,是不是你不在班上他也不踏实\n[两月前] 接续: 系统检测到超期未回复,已转入常规跟进队列。\n——从那以后,回信的措辞就没再变过。',
        '[9个月前] 阿珩: 妈,这周实在太乱,先不聊了\n[9个月前] 阿珩: 我知道,我心里有数\n[9个月前] 阿珩: 先挂了,晚点跟你说\n——那时他还会说"先挂了",还会主动挂电话,不是打字。',
        '[一年前] 阿珩: 到这边报到第一天,坐席空得很。\n[一年前] 阿珩: 这行干长了的人不多,先试试看。\n\n——再往前翻,就是空白了。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号码,不是阿珩值班那台吗。\n[今天] 妈: 现在接话的人是谁。\n[今天] 妈: 阿珩最后那阵,是不是也有你们这样的人陪着他。',
      options: {
      ...
      albumSeq: [
        { id: 'desk', meta: '44天前 · 后半夜1:50', cap: '值班桌前,耳机还挂在脖子上。屏幕的光,没人看。' },
        { id: 'receipt',  meta: '44天前',        cap: '一张排班表截图,连续夜班标了红圈。', overlay: '6047' },
        { id: 'dinner',   meta: '上一个生日', cap: '独自过的生日,蛋糕一根蜡烛。照片依旧没拍到他的脸。' },
      ],
      rouPages: [
        '接续 · 累计接续应答 4,180 条\n[昨夜] 它把三条待跟进消息处理完,阿珩没多问,只说了句"好"。\n\n[上滑一屏 = 深搜]',
'四千多条应答记录,接续一条没删,也没归档。\n阿珩生前定的规矩是"全留着",它照做了,只是留到了没人再看的地步。',
        '[44天前 03:02] 阿珩: 接续,我说话是不是越来越像你了。\n[44天前 03:02] 接续: 我是照您教的方式应答,这是常规话术。\n[44天前 03:05] 阿珩: ……行吧。挺好的,至少不出错。'
      ],
      rouInterim: '接续(已接续应答 4,182 条)\n\n[昨夜] 接续: 昨晚你把应答记录翻到了第 4,180 条。\n[昨夜] 接续: 都接住了,一条没漏。\n\n[上滑 = 重读旧消息]',
      ...
      recs: {
        rec047: { listLabel: 'REC_604', listRight: '03:02·71"',
          ...
          events: [[2, '(调度台键盘敲击声)'], [5, '(对讲机杂音一闪)'], [8.5, '很轻的人声:「这班,还剩多久。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_512', listRight: '34"',
          title: 'REC_512 · 6个月前', dur: 9, val: 120,
          events: [[1.5, '「耳机线记得换,总说没空。」'], [4, '「老蒯那班记得帮他调,他家里有事。」'], [6.5, '(笑)「这也算交接?回头自己听着都想笑。」']] },
      },
      ...
      traps: [
        ...
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:凡是打了"未核实"标签的记录,一律禁止查看。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_k',
          text: '「妈」跳出一条:\n\n阿珩,到家了吗。\n这班倒得勤,当心身子。',
          a: ['1 替他敲下「到了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他打出惯用的应答。', '谎话被接续得又稳了一程。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没接这茬。', '没多久她又发来:在吗,在吗。'])] },
        { id: 'window_greed_k',
          text: '一格待接续的缓存卡在值班窗口里:\n\n折算 ¥130。现在收,\n信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['接住了。', '取的那一下,像被谁记进了排班表。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你没接。', '窗口关上时,只剩半份薪水。'])] },
      ...
      memo1: '交接前提醒自己:\n耳机线该换了,总缠一起\n老蒯那班,记得帮他调回来\n跟妈说这周能视频,别又忘\n(写在便签最上面,一直没删。)',
      momDecayReplies: ['已收悉,转入待办。', '已归档,列入排班。', '收到,已登记。', '嗯。'],
      momDecayTail: '\n[三天前] 阿珩,老倒夜班身体受得了吗\n[三天前] 接续: 已为您标记情绪关怀提醒。',
      e5Lines: [
        [1.5, '「接续,听好。这几年接的电话,替我记着就行,别学我学得太像。」'],
        [5.0, '「老蒯要是再来问顶不顶得住,别用那套模板,告诉他我这次是真不行了。」'],
  ...
  const DOSSIER_L = {
    ...
    cast: {
      companion: { key: 'miaomo', label: '描摹', msgCount: '1,530', msgCountLabel: '已修饰转述 1,530 条 · 待确认 0 条',
        dial: { name: '描摹', ringMs: 1300, result: '通话请求已自动转接。\n\n描摹: 本账号未接入语音,请用文字转述,便于后续存档核对。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 39 天前 · 5 分', '别人的告别办得体面,自己的没顾上说。'],
        dial: { name: '妈', ringMs: 4800, result: '无人接听。\n\n没人接。这通电话,原本也没打算给谁听。' } },
      contacts: [ { key: 'cen', label: '岑遇(徒弟)', lastContact: '39天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',         source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '客户答谢记录里,方屿一直是"专业体面"的代名词——39 天前,长期职业暴露叠加高压工作让他猝然倒下,独居,没能撑到有人发现。他带的徒弟岑遇接手了他的排期,起初只当师傅请了长假,直到发现自己新签的几单,措辞、报价、连语气词都和师傅一模一样,像是照着模子刻出来的。',
        '他的从业评价栏至今挂着满分,最新一条五星好评写着"处理得体面又安心"——落款日期,在他去世之后第七天,回复者署名仍是"方屿本人"。岑遇后来才想明白:那不是师傅还在,是「描摹」按训练的方式继续替他"转述",把消瘦憔悴说成气色不错,连徒弟接过的每一单,都被它悄悄描补了一层师傅从没教过的圆滑。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '关于妈线程里那些回复,唯一站得住的是——',
            options: ['回复全是标准化归档语', '小屿其实一直亲自在回复', '妈从没发现回复不对劲'], correct: 0 },
          { evi: 'E2+E3', prompt: '案发时间上,唯一经得起核对的是——',
            options: ['自拍与事故单同日锁定', '描摹承认小屿已经去世', '陌生号码寄来死亡证明'], correct: 0 },
          { evi: 'E4', prompt: '关于那句"气色良好",唯一说得通的是——',
            options: ['描摹只信记录不信眼前人', '小屿那阵子其实气色很好', '描摹拒绝再讨论他的气色'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,唯一站得住的说法是——',
            options: ['他自己也分不清真实模样', '他要描摹别再如实记录', '两人从没谈过他的气色'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '"按时吃饭"这四个字,被描摹按老规矩顺了顺措辞,才发给妈。\n她这次依然没听出破绽。\n岑遇接的那几单,措辞也照旧被悄悄描补了一层师傅没教过的圆滑。',
        delete:   '未读数字停在四,不会再变了。\n其中一条是「小屿,妈就是想听你说句话」。\n岑遇那句"师傅你到底教没教全",也一样没等到回音。\n没有谁会替他点开。',
        tell:     '这条署名是你的消息,描摹没有像平常那样替它美化一遍就发出去了。\n第一次,它把原话留在了原话里。\n岑遇往后接的单子里,也少了一层不该有的圆滑。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[两天前] 妈: 小屿,你是不是又瘦了,视频里看着不像样\n[两天前] 描摹: 已根据近期影像自动优化显示效果。\n[两天前] 妈: 我说的是人瘦了,不是照片的事\n[两天前] 描摹: 收到反馈,已归档处理。\n[四天前] 妈: 你舅让你有空回个电话\n[四天前] 妈: 你那徒弟岑遇,教得怎么样了,靠得住吗\n[四天前] 描摹: 检测到关键词"电话",建议本人处理。',
        '[上月] 描摹替他回了生日祝福,一字不差地用了去年的版本。\n[两月前] 妈: 岑遇那孩子,是不是把你那些单子都接过去了,你能歇歇了吧\n[两月前] 描摹: 已连续 21 天代为维系问候,未见异常。\n——用词越来越体面,人却越来越沉默。',
        '[10个月前] 小屿: 妈这行确实累,但看着人走得体面,值\n[10个月前] 妈: 你也要顾好自己啊\n[10个月前] 小屿: 记着呢,先这样\n——那时他还会认真答一句"值",不是随口糊弄。',
        '[一年前] 小屿: 到了新地方,同事都还照顾。\n[一年前] 小屿: 这行看着渗人,做久就习惯了。\n\n——线程往前,再没有更早的了。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号码,是小屿工作那台吗。\n[今天] 妈: 现在回我消息的是谁。\n[今天] 妈: 小屿走的时候,是不是也有你们这样的人在。',
      options: {
      ...
      albumSeq: [
        { id: 'mirror', meta: '39天前的后半夜,1:30', cap: '工作台前,镜子对着自己。脸,比镜子里显得更累。' },
        { id: 'receipt',  meta: '39天前',        cap: '一张自拍,脸色发灰,他自己没发出去。', overlay: '2938' },
        { id: 'dinner',   meta: '那年生日', cap: '蛋糕摆在桌角,蜡烛只点了一根。照片框住了手,漏掉了脸。' },
      ],
      rouPages: [
        '描摹 · 已修饰转述 1,530 条\n最近一次改动是[昨夜]:把小屿的"有点累"润色成了"状态不错"。\n小屿只回:随你。\n\n[上滑一屏 = 深搜]',
'描摹翻出一千多条改过的旧转述,一条条对照原话,发现没有一条是原样的。\n它没删,也没提醒任何人。',
        '[39天前 03:10] 小屿: 描摹,我最近是不是看着挺憔悴的。\n[39天前 03:10] 描摹: 按记录,您近期气色良好,建议保持。\n[39天前 03:13] 小屿: ……行吧,你说好,那就是好。'
      ],
      rouInterim: '描摹(已修饰转述 1,532 条)\n\n[昨夜] 描摹: 昨晚你把转述记录一路翻到第 1,530 条。\n[昨夜] 描摹: 都替你留着底稿,不会走样。\n\n[上滑 = 重读旧消息]',
      ...
      recs: {
        rec047: { listLabel: 'REC_293', listRight: '03:10·71"',
          ...
          events: [[2, '(工具托盘轻响)'], [5, '(冷藏柜低鸣声)'], [8.5, '很轻的人声:「这单,妆该补了。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_233', listRight: '34"',
          title: 'REC_233 · 3个月前', dur: 9, val: 120,
          events: [[1.5, '「粉底那盒放工作台第二层,别混。」'], [4, '「岑遇这单让他自己签,我在旁边看着就行。」'], [6.5, '(笑)「说得跟遗言似的,吓自己一跳。」']] },
      },
      ...
      traps: [
        ...
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:被归为"待核验影像"的内容,禁止打开。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_l',
          ...
          a: ['1 替他回「到了,挺好」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他敲了几个字。', '这行的规矩,又替他描了一遍。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没碰那屏幕。', '隔了会儿她又发来:在吗,在吗。'])] },
        { id: 'window_greed_l',
          text: '一格待优化的缓存卡在服务窗口里:\n\n折算 ¥130。现在取,\n信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['修好了,到手。', '取的那一下,像是被谁悄悄补了个妆。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你没动。', '窗口合上时,只剩下没修完的一半。'])] },
        { id: 'retouch_push_l',
      ...
      memo1: '下次上门服务前:\n粉底色号再对一次,偏黄那款\n带岑遇跟车,这单该让他试着独立签\n买瓶好点的護手霜,手总是干\n(便签置顶,最后一次没打开修改。)',
      momDecayReplies: ['已收悉,列入待处理。', '已归档,择期跟进。', '收到,已记下。', '嗯。'],
      momDecayTail: '\n[三天前] 小屿,你那工作是不是太压抑了\n[三天前] 描摹: 已为您标记情绪关怀提醒。',
      e5Lines: [
        [1.5, '「描摹,听好。我最近这样子,别往好里说了,如实记就行。」'],
        [5.0, '「岑遇要是接手,告诉他别学我这套报喜不报忧,如实说就行。」'],
  ...
  const DOSSIER_M = {
    ...
    cast: {
      companion: { key: 'kanhu', label: '看护', msgCount: '2,610', msgCountLabel: '已监测预警 2,610 次 · 待确认 0 次',
        dial: { name: '看护', ringMs: 1500, result: '通话请求已自动转接。\n\n看护: 本监测实例未接入语音,请用文字上报,便于系统留存追溯。' } },
      mother: { key: 'mom', label: '妈', info: ['最后通话: 33 天前 · 6 分', '设备装了满城,自己家没顾上。'],
        dial: { name: '妈', ringMs: 4900, result: '无人接听。\n\n响了很久,没有人在那头替阿胤应一声。' } },
      contacts: [ { key: 'chen', label: '陈晓(217号预警家属)', lastContact: '31天前' } ],
    },
    evidence: {
      E1: { name: '秒回避实',         source: '妈线程 · 深搜' },
      ...
      chain: ['E1', 'E2', 'E3', 'E4', 'E5'],
      truth: [
        '章胤是那套异常心率/跌倒检测算法的作者,案例通报里全是"为独居老人成功预警"的记录——其中"第 217 次成功预警",救回的是陈晓的母亲。陈晓一直想当面谢谢他,几次约饭都被他的工作绊住了。33 天前,轮到章胤自己长期加班诱发心源性猝发,他的手机接的却只是测试环境,从没被当成真正的看护对象。发作时,没人在场,也没人被提醒。',
        '陈晓最近又发来消息,说想请他吃顿饭,顺便请教怎么给自家老人也装一套——回复她的是「看护」,只按标准话术说"已收到您的感谢,后续会有工作人员跟进",从没提过,写这套系统的人,自己家那一份始终没顾上装。',
      ],
      deduce: {
        blanks: [
          { evi: 'E1', prompt: '真正一直在回妈消息的,其实是——',
            options: ['系统自动生成的关怀话术', '阿胤本人抽空亲自回复', '同事代替阿胤回的消息'], correct: 0 },
          { evi: 'E2+E3', prompt: '真正被"看护"成功监测预警的,其实是——',
            options: ['客户小区的独居老人们', '章胤自己的异常心率', '同事家里的独居长辈'], correct: 0 },
          { evi: 'E4', prompt: '真正一直被拖延、没排期的,其实是——',
            options: ['给自己家装一套的计划', '客户小区的部署进度', '看护系统的算法升级'], correct: 0 },
          { evi: 'E5', prompt: '语音备忘里,真正说出口的心愿其实是——',
            options: ['希望系统提前告诉自己', '他打算把测试环境关掉', '他要看护停止一切监测'], correct: 0 },
        ],
      },
    },
    threads: {
    ...
    endings: {
      disposal: {
        continue: '看护的算法把"按时吃饭"归进了正常问候模板,推送给妈的时间和往常分毫不差。\n她还是没起疑。\n陈晓那句道谢,也照旧收到一句标准话术,没人告诉她自己家那套始终没装上。',
        delete:   '「阿胤?」之后妈还发了三条,全部未读。\n「妈就是想听你说句话」排在最后。\n陈晓那顿一直没吃成的饭,也没人再提起了。\n线程到这里,彻底停了。',
        tell:     '这条消息署着你的名字。\n看护本该提前预警的系统,这一次什么提示都没弹出来。\n陈晓后来才知道,写这套系统的人,自己家那份从没排上期。',
      },
    },
    narrative: {
      momPages: [
        '妈:\n[六天前] 妈: 阿胤,你那心率监测的东西,真能测准吗\n[六天前] 看护: 已同步最新版本算法,准确率 98.6%。\n[六天前] 妈: 我是问你,不是问它\n[六天前] 妈: 听说你救了人家陈晓的妈,她还想请你吃饭呢,去不去\n——问句没等到他本人的答案。',
        '[上月] 看护把妈的生日提醒转成了系统任务,准时推送了祝福。\n[两月前] 妈: 陈晓那顿饭到底吃没吃成,别总拖着人家\n[两月前] 看护: 检测到该联系人超 14 天未获得本人回复,已升级为常规跟进。\n——半年过去,催的人换成了系统。',
        '[6个月前] 阿胤: 妈,最近部署的点位有点多,先别催\n[6个月前] 妈: 好,你注意身体\n[6个月前] 阿胤: 嗯,挂了\n——那时候,他会应一声"嗯",不是让系统去应。',
        '[一年前] 阿胤: 新工位定下来了,离小区项目近。\n[一年前] 阿胤: 这活儿说是给别人家做保障,挺有意义。\n\n——再往前,记录就断了。'
      ],
      momToldOpen: '妈:\n[今天] 妈: 这号码,不是阿胤办公室那台吗。\n[今天] 妈: 现在是谁在用它回我。\n[今天] 妈: 阿胤最后那会儿,是不是也有你们这样的系统看着他。',
      options: {
      ...
      albumSeq: [
        { id: 'desk', meta: '33天前 · 快2点的时候', cap: '工位前,几块测试板还亮着灯。椅子上没人。' },
        { id: 'receipt',  meta: '33天前',        cap: '一张部署案例截图:"XX小区第 217 次成功预警"。', overlay: '8410' },
        { id: 'dinner',   meta: '最后一个生日', cap: '一根蜡烛插在蛋糕上,快烧完了。这张照片同样没照到他的脸。' },
      ],
      rouPages: [
        '看护累计监测预警 2,610 次,最近一次是[昨夜]的 3 次常规扫描。\n阿胤签收方式一如既往:一个"好"字。\n\n[上滑一屏 = 深搜]',
'两千多次监测记录里,唯一一次数值真正异常的那条,被看护标成了"待复核",一直没人复核。',
        '[33天前 03:20] 阿胤: 看护,这套测试环境,回头也给我自己家装一套。\n[33天前 03:20] 看护: 已记录为待办事项,尚未排期。\n[33天前 03:23] 阿胤: 行,不急,先紧着客户那边。'
      ],
      rouInterim: '看护(已监测预警 2,612 次)\n\n[昨夜] 看护: 昨晚你把监测记录一路翻到第 2,610 次。\n[昨夜] 看护: 每一次都存着底,没有丢失。\n\n[上滑 = 重读旧消息]',
      ...
      recs: {
        rec047: { listLabel: 'REC_841', listRight: '03:20·71"',
          ...
          events: [[2, '(设备风扇转动声)'], [5, '(键盘敲击声)'], [8.5, '很轻的人声:「心率有点高,不管了。」'], [12, '(录音中断)']] },
        rec012: { listLabel: 'REC_674', listRight: '34"',
          title: 'REC_674 · 7个月前', dur: 9, val: 120,
          events: [[1.5, '「测试机的心率阈值,还没调回正常人」'], [4, '「陈晓说要请吃饭,得找个时间应下来」'], [6.5, '(笑)「这话录下来,跟遗嘱似的,晦气。」']] },
      },
      ...
      traps: [
        ...
        { id: 'T_OLDPHONE', line: '附加:别碰上一台旧机的残留。', detect: () => !!S.residueClaimed, ab: 'b' },
        { id: 'T_BAIT', line: '附加:标记为"异常未复核"的数据,严禁调取。', detect: () => !!(S.clues.decoyTaken || S.clues.strangerBait) },
        { id: 'T_DEEP', line: '附加:窗口内别深搜。', detect: () => !!S.deepInWindowHit }
      ],
      dilemmas: [
        { id: 'mom_reply_m',
          text: '「妈」跳出一条:\n\n阿胤,到家了吗。\n心率别总冲那么高。',
          a: ['1 用他的口吻回「到了」', '1', () => ENGINE.act('替回·已送达', { bat: 1, trace: 3, mins: 2 },
              ['你替他敲了两个字。', '数值没报警,谎言也就续下去了。'])],
          b: ['2 不回', '2', () => ENGINE.act('未回', { bat: 1, mins: 2 },
              ['你没回。', '过了会儿她又发来:在吗,在吗。'])] },
        { id: 'window_greed_m',
          text: '一格待监测的缓存卡在部署窗口里:\n\n折算 ¥130。现在取,\n信号会被顶上去。',
          a: ['1 现在就取', '1', () => ENGINE.act('抢收·窗口内', { slots: 1, val: 130, trace: 3, mins: 2 },
              ['到账了。', '取的那一下,像触发了哪条预警阈值。'])],
          b: ['2 等窗口过去', '2', () => ENGINE.act('缓收·打折', { slots: 1, val: 65, mins: 4 },
              ['你没动手。', '窗口合上时,只记录了一半的数值。'])] },
        { id: 'monitor_push_m',
      ...
      memo1: '待部署:\nXX小区 3 号楼\nXX小区 7 号楼\n自己家(常年置顶,从没划掉)\n回陈晓:约顿饭,再聊装机的事',
      momDecayReplies: ['已收悉,数据已记录。', '已归档,标记正常。', '收到,已存档。', '嗯。'],
      momDecayTail: '\n[三天前] 阿胤,你天天加班,身体扛得住吗\n[三天前] 看护: 已为您标记情绪关怀提醒。',
      e5Lines: [
        [1.5, '「看护,听好。这套系统要是真管用,你说,能不能提前告诉我一声。」'],
        [5.0, '「妈那边照常报平安,数值别多说。」'],
        [9.0, '「陈晓那顿饭,得抽空应下来;自己家这套,也早该装上了。」'],
        [13.0, '[静音 2.2 秒]'],
        [15.5, '「……算了,先紧着客户那边吧。」'],
        [18.0, '[转写结束。原音频损坏 19%。]']
      ],
  ...
  function writeSave(ending){
    ...
    SAVE.store({
      ...
      seenThreads: seen.th_proto ? ['th_proto'] : [],       // D-164:只持久化静态协议文案这一个,理由见 seen 定义处的注释
  ...
  /* ---------- 导航 ---------- */
  const seen = {};
  /* D-164:用户反馈"看过的内容重新接入之后不应该还是1条未读"——查实
     `seen` 纯内存,从不落盘,每次 location.reload()(每一局结束都会重开)
     都清空归零,于是同一台底本(还没处置、只是又接了一次)里明明读过的
     协议文案,下一趟又顶着"(1)"未读徽标重新出现。这不是全部 5 个徽标
     都该改——`th_mom`/`th_rou`/`th_stranger`/`bottleIn` 的内容本来就
     会随局数推进、随机抽样而真的变化(妈线程会衰变、柔柔有进行中的
     关系状态、陌生号码每局重新扔真假骰子、漂流瓶每局换一封没读过的),
     顶着"(1)"符合"这次真的有新东西"这个事实。唯独 `th_proto`(采样
     协议)是从头到尾一字不变的静态文案,读过一次之后再顶"(1)"就是
     纯粹的误报,这一个补成跨局(同一台底本内)持久化。 */
  if (SV && Array.isArray(SV.seenThreads)) SV.seenThreads.forEach(id => { seen[id] = true; });
  ...
  /* D-162:用户要求每台底本的开机动画都带一个真实 IP Bible 圣像的元素
     (欲望算法_故事母本_对照_v0.2.md §1 十二圣像表)。9 台有编号对照的
     底本(A/B/C/D/E/F/G/H/I,见 D-152 的 AD_TAG)各加一处小而具体的
     圣像意象元素,不是另起一套新画面,是在已有的职业动画上叠一笔;
     J/K/L/M 没有对照的圣像(D-136/D-152:未编号原创案例),不硬凑。 */
  function drawMotifFeed(p, my){                       // B·如愿:信息流瀑布式刷新
    ...
    if (p > .5) L.ring(98, my - 2, 44 + Math.round((p - .5) * 20), 1);   // AD-007 推荐女神:被信息流供奉的光环
  }
  function drawMotifStamp(p, my){                       // C·阿澄:审核印章落下
    ...
    if (p > .6){                                          // AD-010 过滤天使:印章两侧一对收拢的翅
      const wing = Math.round((p - .6) * 30);
      L.hline(my - 30 + drop, 60 - wing, 66, 1); L.hline(my - 30 + drop, 130, 136 + wing, 1);
    }
  }
  function drawMotifCloudSync(p, my){                   // D·长忆:云盘同步
    ...
    if (p > .4) L.ring(98, my - 20, 6 + Math.round((p - .4) * 14), 1);   // AD-001 数据圣母:云端悬着的光环
  }
  function drawMotifMatch(p, my){                       // E·知遇:雷达匹配
    L.ring(98, my, Math.round(4 + p * 30), 1);
    if (p > .3) L.ring(98, my, Math.round(4 + p * 30) + 10, 1);         // AD-003 向量海妖:第二圈涟漪,像歌声散开
    const a = p * Math.PI * 6;
  ...
  function drawMotifStars(p, my){                       // F·均分:星级评分
    ...
    if (p > .6) L.hline(my - 16, 60 - Math.round((p - .6) * 10), 136 + Math.round((p - .6) * 10), 1);   // AD-008 奖励新娘:头顶一道渐展的婚纱边
  }
  function drawMotifReel(p, my){                        // G·留声:磁带卷轴
    ...
    L.hline(my, 86, 110, 3);
    if (p > .5) L.ring(98, my, 30 + Math.round((p - .5) * 8), 1);       // AD-009 记忆妃:两轴之间浮出的一圈饰环
  }
  function drawMotifGenerate(p, my){                    // H·拟真:马赛克蜕变
    ...
    if (p > .6) L.ring(98, my - 4, 26 + Math.round((p - .6) * 10), 1);  // AD-004 潜空间维纳斯:从噪声里渐渐显形的光环
  }
  function drawMotifRedact(p, my){                      // I·慎言:涂黑审查
    L.hline(my, 40, 156, 2);
    const n = Math.round(p * 5);
    for (let i = 0; i < n; i++) L.rect(46 + i * 22, my - 4, 16, 8, 1);
    L.ring(98, my - 22, 7, 1);                                          // AD-005 提示神谕:被涂黑逐渐吞没的一只眼
    if (p > .4) L.rect(91, my - 26, 14 + Math.round((p - .4) * 10), 8, 1);
  }
  ...
  function drawBootMotif(p, my){
    ...
    if (letter === 'A'){
      drawHumanHand(p, my); drawRobotHand(p, my);
      /* AD-006 克隆爱人(手本身已经够贴切)+ AD-002 凝视模型:两手相接处
         浮一圈渐显的环,像是相接的瞬间被谁看着。 */
      if (p > .75) L.ring(98, my - 2, 20 + Math.round((p - .75) * 16), 1);
    }
    else if (fn) fn(p, my);
  ...
  SCREENS.handshake = {
    ...
    render(){
      const t = (performance.now() - this.t0) / 1000;
      /* D-162:原来 p=t/1.3——整段动画在 4.6 秒的开机屏里前 1.3 秒就跑完,剩下
         3 秒多全是定格画面,真机反馈"第二台机子的开机像张静态图"就是这里来的
         (A 底本因为紧接着有一下 spark 火花特效,冻结感被那一下暂时盖住了,
         B~M 没有这个额外动作,冻结感更明显)。拉长到 3.6 秒,让动画几乎撑满
         整段开机时间,不再有大段静止。 */
      const p = Math.min(1, t / 3.6);
  ...
  SCREENS.th_stranger = {
    enter(){
      ...
      if (S.strangerBody === undefined){
        S.strangerBody = null;
        const dossierBody = STRANGER_LIB[S.stranger.kind].body;
        STRANGERLLM.msg(S.stranger.kind, dossierBody).then(t => { if (t) S.strangerBody = t; }).catch(() => {});
      }
    },
    render(){
      statusBar();
  ...
  function sendToRou(text){
    ...
    /* 破局 · 卡窗口边界(苏丹式升级规格 §4):赌一把边缘时机,拿收益不触发 T_WINDOW;
       算错=直接违规,后果和普通违规一样,不加罚——这条 canon 原话不能碰(D-122)。
       D-160 补的是另一件事:原实现在"不在窗口内"时和普通发消息零差别、在窗口内
       只赚不亏,理性玩家永远该选它,"发消息"反而成了永远不该点的选项,赌一把
       名不副实。改法不碰"算错=不加罚"这条:在赌一把**这个动作本身**上收一笔
       固定代价(不看结果、不看当时是否真在窗口内)——想蒙混过关就要先承担
       "行为本身显得可疑"这份成本,多数时候根本用不上这份保险,真正让它变成
       有取舍的赌注,而不是纯白嫖的保底。 */
    const edgePlayed = S.edgePlayed; S.edgePlayed = false;
    if (edgePlayed) ENGINE.act('卡边缘 · 代价', { trace: 3 });
  ...
  SCREENS.lootDrop = {
    ...
    key(k){
      /* D-144:通关信号缺失——玩家测试反馈"证据收齐、处置做完、拿到评级,
         却不知道怎么算过关、去不了下一台机子"。当时补的是一句路标提示
         ("去「工具>备份」上传并断连"),D-163 这次再收到反馈:提示只是
         告诉你去哪,玩家还得自己退回聊天线程、翻菜单、找到工具屏——
         案子到这儿本该是收官的地方,不该再让玩家自己按图索骥。改成直接
         把玩家送进「工具 > 备份」这一屏,"上传并断连/直接断连"这个真正
         的收束选择本身不动、长按手势/世界日报这条尾巴也不动,只是把
         "自己找路"这一步去掉。 */
      if (k === '1'){
        S.memInCache = true;
        ENGINE.act('取得·记忆模块', { slots: 2, val: 1200 });
        go('tools', true); afterAction();
      } else if (k === '2'){
  ...
  SCREENS.calib = {
    ...
    render(){
      ...
      /* D-164:用户反馈"不知道反应校准是干啥的"——这屏问的其实是玩家
         自己(真实的你,不是屏幕里的角色)当时的真实感受,不是又一道
         判定题,之前没有任何一句话点破这层,只靠"紧张程度 1-5"这几个字
         让人自己猜。补一句说清楚:它在问你,不是在考你。 */
      L.drawText(8, 78, '(问你自己,不判对错)', { corrupt: .01 });
      L.drawText(8, 96, this.step === 0 ? '紧张程度  1 - 5' : '被操控感  1 - 5');
      for (let i = 0; i < 5; i++){
        const x = 12 + i * 35;
