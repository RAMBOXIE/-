...
function fixtures(dossierId){
  ...
  if (dossierId) Object.assign(base, { dossierId, history:[{cacheVal:100, inst:'#' + ({B:'5029',C:'3319',D:'8842',E:'6153',F:'2087',G:'4419',H:'3567',I:'5620'}[dossierId]) + '-A'}] });
  return {
...
for (const dossierId of [undefined, 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I']){
